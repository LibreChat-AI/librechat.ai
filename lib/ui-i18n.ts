...
export const uiI18n = defineI18nUI(i18n, {
  ...
  'pt-BR': { displayName: LOCALE_NAMES['pt-BR'] },
  it: { displayName: LOCALE_NAMES.it },
  nl: { displayName: LOCALE_NAMES.nl },
  pl: { displayName: LOCALE_NAMES.pl },
  vi: { displayName: LOCALE_NAMES.vi },
  ko: { displayName: LOCALE_NAMES.ko },
  id: { displayName: LOCALE_NAMES.id },
  tr: { displayName: LOCALE_NAMES.tr },
})
