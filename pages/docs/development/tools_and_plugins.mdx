...
You are essentially creating DynamicTools in LangChain speak. See the **[LangChainJS docs](https://js.langchain.com/v0.1/docs/modules/agents/tools/dynamic/)** for more info.
