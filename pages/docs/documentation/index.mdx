...
- Ensure any HTML has closing tags (e.g., `<Image src="" />` or `<a href="link"></a>`).
...
**Note In the following example:**
  ...
  - I used `Image from 'next/image'` which gave me 4x improvement on the image file size for better performances.
