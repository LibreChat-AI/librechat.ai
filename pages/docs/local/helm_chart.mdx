...
`helm install <release-name> oci://ghcr.io/danny-avila/librechat-chart/librechat`

Example: `helm install librechat oci://ghcr.io/danny-avila/librechat-chart/librechat --set config.envSecrets.secretRef=librechat` (using one Kubernetes secret for all credentials). 
