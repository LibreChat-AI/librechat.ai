...
In the "Custom Instructions" or "Additional Instructions" for the Assistants, you can use the special variables {{current_date}} and {{current_user}} which will be replaced automatically before sending the request, exactly as for the custom prompts.
