...
In the "Custom Instructions" or "Additional Instructions" for the Assistants, you can use the special variable {{current_date}} which will be replaced automatically before sending the request
