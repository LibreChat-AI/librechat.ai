...
- **Multiple Providers**: Generate images with [**GPT-Image-1**](/docs/features/image_gen#1--openai-image-tools-recommended), [**DALL-E**](/docs/features/image_gen#2--dalle-legacy), [**Stable Diffusion**](/docs/features/image_gen#3--stable-diffusion-local), [**Flux**](/docs/features/image_gen#4--flux), and more.
...
- **Flexible Options**: Control quality, size, and background transparency for professional results
