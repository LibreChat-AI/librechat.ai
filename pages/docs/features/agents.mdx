...
To start using MCP Servers with Agents:
...
4. Click the "Add Tools" button in the Agent Builder panel.
5. Select the MCP server tool(s) you want to add.
6. "Save" your changes to the agent.

After clicking "Add Tools", you should see the Tools Dialog open, where you can select the MCP server tool(s) you want to add.
