---
title: File Context (OCR) - Extract Text from Images and Documents
...
```yaml
ocr:
  mistralModel: "mistral-large-latest"  # Optional: Specify Mistral model
  apiKey: "your-mistral-api-key"        # Optional: Defaults to OCR_API_KEY env variable
  strategy: "mistral_ocr"               # Default strategy
```

For detailed configuration options, see the [OCR Config Object Structure](/docs/configuration/librechat_yaml/object_structure/ocr_config).
...
For more information on configuring OCR, see the [OCR Config Object Structure](/docs/configuration/librechat_yaml/object_structure/ocr_config).
