...
For supported LLM Providers (**OpenAI, AzureOpenAI, Anthropic, and Google**) and models, files can now be sent directly to the provider APIs as message attachments,
