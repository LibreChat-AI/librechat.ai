...
<OptionTable
  options={[
    ...
    ['OPENID_OPTIONAL_EMAIL', 'boolean', 'If true, it allows login to use preferred_username as a fallback when the email claim is absent', 'OPENID_OPTIONAL_EMAIL=true'],
