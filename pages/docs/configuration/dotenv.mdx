...
<OptionTable
  options={[
    ...
    ['OPENID_CUSTOM_DATA', 'string', 'Define which fields from the OpenID profile should be dynamically fetched and stored in the user model.','OPENID_CUSTOM_DATA=department title'],
  ]}
/>
