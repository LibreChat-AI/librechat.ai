...
<OptionTable
  options={[
    ...
    ['OPENID_CUSTOM_DATA', 'string', 'Space separated list of additional data you want to fetch from your openID provider','OPENID_CUSTOM_DATA=department role'],
    ['OPENID_CUSTOM_DATA_PROVIDER', 'string', 'OpenId provider name - microsoft or google or amazon, etc','OPENID_CUSTOM_DATA_PROVIDER=microsoft'],
