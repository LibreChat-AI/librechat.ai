...
<OptionTable
  options={[
    ...
    [
      'COHERE_API_URL',
      'string',
      'Custom Cohere API endpoint (optional). Enables integration with LiteLLM proxy or custom Cohere-compatible endpoints. Defaults to https://api.cohere.ai/v1 when not set.',
