...
<OptionTable
  options={[
    ['SAML_METADATA', 'string', 'The SAML metadata, provided as a file path or a one-line XML string.','SAML_METADATA='],
    ...
    ['SAML_BUTTON_LABEL', 'string', '<Optional>: The label for the SAML login button (default: Continue with SAML).','SAML_BUTTON_LABEL="Continue with SAML"'],
