---
title: Forwarded Authentication
description: Configure LibreChat to use forwarded HTTP headers for authentication when using a reverse proxy that handles authentication before requests reach LibreChat.
---
