...
webSearch:
  ...
  cohereApiUrl: '${COHERE_API_URL}' # Optional: Custom Cohere endpoint
...
<OptionTable
  options={[
    [
      'cohereApiUrl',
      'String',
      'Environment variable name for custom Cohere API endpoint. Optional - enables integration with LiteLLM proxy or custom Cohere-compatible endpoints. Defaults to https://api.cohere.ai/v1 when not set.',
      '${COHERE_API_URL}',
    ],
  ]}
/>
...
- Docker setup: `COHERE_API_URL=http://cohere-proxy:8000/v1`
- Custom endpoint: `COHERE_API_URL=https://your-cohere-endpoint.com/v1`
