...
<OptionTable
  options={[
    ['temperature', 'Number', 'Model response temperature.', ''],
  ]}
/>
...
<OptionTable
  options={[
    ['top_p', 'Number', 'Value of top_p (nucleus sampling).', ''],
  ]}
/>
...
<OptionTable
  options={[
    ['topK', 'Number', 'Value of topK (k-sampling).', ''],
  ]}
/>
...
<OptionTable
  options={[
    ['frequency_penalty', 'Number', 'Penalty for repetition in model responses.', ''],
  ]}
/>
...
<OptionTable
  options={[
    ['presence_penalty', 'Number', 'Penalty for repetition in model responses.', ''],
  ]}
/>
...
<OptionTable
  options={[
    ['stop', 'Array of Strings', 'Stop tokens for model responses.', ''],
  ]}
/>
...
<OptionTable
  options={[
    ['max_tokens', 'Number', 'The maximum number of output tokens to request from the model.', 'Useful for custom or non-standard models, e.g. phi-3.'],
  ]}
/>
