...
<OptionTable
  options={[
    ['greeting', 'String (optional)', 'A predefined message that is visible in the UI before a new chat is started. This is a good way to provide instructions to the user, or to make the interface seem more friendly and accessible. This text is parsed as markdown to support links etc.', ''],
  ]}
/>
