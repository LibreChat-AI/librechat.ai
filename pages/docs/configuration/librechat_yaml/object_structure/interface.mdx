...
<OptionTable
  options={[
    ['customWelcome', 'String', 'Allows administrators to define a custom welcome message for the chat interface, with the option to personalize it using the {{user.name}} parameter.', 'This message will be displayed to users upon entering the chat, providing a personalized greeting.'],
  ]}
/>
