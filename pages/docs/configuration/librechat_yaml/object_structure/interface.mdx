...
- **Object (`prompts: { use: true, share: true }`)**: Updates all specified sub-permissions. Use this when you want explicit control over permissions via the configuration file.
...
- **Object (`agents: { use: true, share: true }`)**: Updates all specified sub-permissions. Use this when you want explicit control over permissions via the configuration file.
