...
<OptionTable
  options={[
    ...
    ['idleTimeout', 'Number', '(Optional) Timeout in milliseconds for user connections. If a user is inactive for this duration, their connection will be closed.', 'idleTimeout: 1800000'],
...
- **User Idle Management:**
  - User connections are monitored for activity and will be disconnected after the specified `idleTimeout` period of inactivity.
  - This helps manage resources efficiently in multi-user environments.
