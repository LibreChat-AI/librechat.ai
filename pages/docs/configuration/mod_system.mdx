...
<OptionTable
  options={[
    [
      'LOGIN_MAX',
      'number',
      'The max amount of logins allowed per IP per LOGIN_WINDOW. Defaults to `7`.',
    ],
    [
      'LOGIN_WINDOW',
      'number',
      'In minutes, determines the window of time for LOGIN_MAX logins. Defaults to `5`.',
    ],
    [
      'REGISTER_MAX',
      'number',
      'The max amount of registrations allowed per IP per REGISTER_WINDOW. Defaults to `5`.',
    ],
    [
      'REGISTER_WINDOW',
      'number',
      'In minutes, determines the window of time for REGISTER_MAX registrations. Defaults to `60`.',
    ],
  ]}
/>
