...
### Sleep
- [Sleep Tool](/docs/configuration/tools/sleep)
- No API key required
- Allows agents to delay execution for a specified period
- Supports seconds, minutes, and hours
- Maximum duration: 10 minutes
- **Note**: Default timeout is 3 minutes - see [documentation](/docs/configuration/tools/sleep#important-timeout-configuration) for configuring longer sleeps
