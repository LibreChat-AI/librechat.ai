...
- **Cloud STT**
  ...
  - Other OpenAI-compatible STT services (via API calls)

#### Configuring Local STT

- **Browser-based:** No setup required. Ensure the "STT button" in the speech settings tab is enabled and "Browser" is selected in the engine dropdown.
- **Whisper Local:** Requires a local Whisper instance.
...
- **Browser-based:** No setup required. Ensure the "TTS button" in the speech settings tab is enabled and "Browser" is selected in the engine dropdown.
- **Piper:** Requires a local Piper instance.
...
- **Coqui:** Requires a local Coqui instance.
...
- **Other ElevenLabs-compatible TTS services:**
