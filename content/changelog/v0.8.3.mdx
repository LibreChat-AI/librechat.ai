...
- **Event-Driven Lazy Tool Loading**
  - MCP tools load on-demand, reducing context window usage. Includes programmatic tool calling UI.
...
- **Local Document Text Extraction**
  - PDF, DOCX, XLS/XLSX, and OpenDocument parsing locally, no external OCR needed.
...
- **Agent Duplication**
  - Editors can now duplicate agents. Token usage tracking and `messageId` in transactions.
- **Security**
