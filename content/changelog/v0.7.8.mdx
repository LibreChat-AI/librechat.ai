...
- **[Agent Chain](https://www.librechat.ai/docs/features/agents#agent-chain)**: Sequential mixture-of-agents enabling multiple specialized AIs to collaborate on complex tasks
- **[Mistral OCR for text extraction](https://www.librechat.ai/docs/features/ocr)**: from documents and gpt-4o-transcribe for audio transcription
...
- **Cloud Storage**: [S3](https://www.librechat.ai/docs/configuration/cdn/s3) and [Azure Blob](https://www.librechat.ai/docs/configuration/cdn/azure) integration with auto-refreshing URLs for robust file handling
- **[OpenAI Image Tools (GPT-Image-1)](https://www.librechat.ai/docs/features/image_gen)**:  for generating and editing images
- **Special date/time Variables**:  for prompts and agents that are used dynamically
- **[Automatic balance refill system](https://www.librechat.ai/docs/configuration/token_usage#balance-configuration)**:  and enhanced Redis integration for rate limiting
...
- 🌍 i18n: Add Thai Language Support, Update Translations, and Add Persian Localization Support by **@rubentalstra** in [#6219](https://github.com/danny-avila/LibreChat/pull/6219),  [#6669](https://github.com/danny-avila/LibreChat/pull/6669)
- 🌍 i18n: Update translation.json with latest translations by **@github-actions[bot]** in [#6220](https://github.com/danny-avila/LibreChat/pull/6220), [#6240](https://github.com/danny-avila/LibreChat/pull/6240), [#6241](https://github.com/danny-avila/LibreChat/pull/6241), [#6277](https://github.com/danny-avila/LibreChat/pull/6277), [#6414](https://github.com/danny-avila/LibreChat/pull/6414), [#6505](https://github.com/danny-avila/LibreChat/pull/6505), [#6530](https://github.com/danny-avila/LibreChat/pull/6530), [#6667](https://github.com/danny-avila/LibreChat/pull/6667)

## New Contributors
* **[@sh4shii](https://github.com/sh4shii)** made their first contribution in [#6248](https://github.com/danny-avila/LibreChat/pull/6248)
* **[@KunalScriptz](https://github.com/KunalScriptz)** made their first contribution in [#6316](https://github.com/danny-avila/LibreChat/pull/6316)
* **[@perweij](https://github.com/perweij)** made their first contribution in [#6383](https://github.com/danny-avila/LibreChat/pull/6383)
* **[@Odrec](https://github.com/Odrec)** made their first contribution in [#6392](https://github.com/danny-avila/LibreChat/pull/6392)
* **[@mjaverto](https://github.com/mjaverto)** made their first contribution in [#6440](https://github.com/danny-avila/LibreChat/pull/6440)
* **[@peeeteeer](https://github.com/peeeteeer)** made their first contribution in [#6858](https://github.com/danny-avila/LibreChat/pull/6858)
* **[@dblock](https://github.com/dblock)** made their first contribution in [#6831](https://github.com/danny-avila/LibreChat/pull/6831)
* **[@andresgit](https://github.com/andresgit)** made their first contribution in [#7223](https://github.com/danny-avila/LibreChat/pull/7223)
* **[@glowforge-opensource](https://github.com/glowforge-opensource)** made their first contribution in [#7232](https://github.com/danny-avila/LibreChat/pull/7232)
* **[@technicalpickles](https://github.com/technicalpickles)** made their first contribution in [#7270](https://github.com/danny-avila/LibreChat/pull/7270)

**Full Changelog**: https://github.com/danny-avila/LibreChat/compare/v0.7.7...v0.7.8
