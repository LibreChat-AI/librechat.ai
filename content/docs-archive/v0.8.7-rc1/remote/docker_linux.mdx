...
> ⚠️ This guide was originally designed for [Digital Ocean](/v0.8.7-rc1/docs/remote/digitalocean), so you may have to modify the instruction for other platforms, but the main idea remains unchanged.
...
Next, we create the [LibreChat Config file](/v0.8.7-rc1/docs/configuration/librechat_yaml), AKA `librechat.yaml`, allowing for customization of the app's settings as well as [custom endpoints](/v0.8.7-rc1/docs/configuration/librechat_yaml/ai_endpoints).
...
**Resources:**
- [Tokens/Apis/etc](/v0.8.7-rc1/docs/configuration/pre_configured_ai)
- [User/Auth System](/v0.8.7-rc1/docs/configuration/authentication)
...
I won't be walking you through custom domain setup or any other changes to NGINX, you can look into the [Cloudflare guide](/v0.8.7-rc1/docs/remote/cloudflare), the [Traefik guide](/v0.8.7-rc1/docs/remote/traefik) or the [NGINX guide](/v0.8.7-rc1/docs/remote/nginx) to get you started with custom domains.
