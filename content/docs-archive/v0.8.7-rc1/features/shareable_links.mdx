...
_Access the share option from the conversation menu_

### Option 2: From the Share Button

![Click the share button in conversation](/images/shared-links/share-button.png)
_Use the dedicated share button in your active conversation_
...
<div style={{ display: 'flex', gap: '20px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
  <div style={{ flex: '1', minWidth: '300px' }}>
    ![Create share link modal](/images/shared-links/share-modal-create.png) *Initial share link
    creation modal*
  </div>
  <div style={{ flex: '1', minWidth: '300px' }}>
    ![Share link modal with options](/images/shared-links/share-modal-options.png) *Shared link
    configuration modal*
  </div>
</div>
...
<div style={{ display: 'flex', gap: '20px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
  <div style={{ flex: '1', minWidth: '300px' }}>
    ![QR code generation for shared link](/images/shared-links/qr-code.png) *Generate QR codes for
    instant mobile access to shared conversations*
  </div>
  <div style={{ flex: '1', minWidth: '300px' }}>
    ![QR code download options](/images/shared-links/qr-code-download.png) *QR code will link to the
...
_How recipients see your shared conversation_
...
<div style={{ display: 'flex', gap: '20px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
  <div style={{ flex: '1', minWidth: '300px' }}>
    ![Branching menu in shared conversations](/images/shared-links/branching-menu.png) *Access
    different conversation branches using the branch navigation arrows*
  </div>
  <div style={{ flex: '1', minWidth: '300px' }}>
...
_Generated artifacts remain interactive in shared conversations_
...
_Recipients can customize language and theme preferences_
...
<div style={{ display: 'flex', gap: '20px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
  <div style={{ flex: '1', minWidth: '300px' }}>
    ![Shared links management dashboard](/images/shared-links/management-modal.png) *Centralized
    dashboard for managing all your shared links*
  </div>
  <div style={{ flex: '1', minWidth: '300px' }}>
    ![Shared link details and options](/images/shared-links/management-details.png) *View details
    and manage individual shared links*
  </div>
</div>
...
Role permissions control which users can create links, share links with authenticated users, or make links visible to everyone on the instance:
...
`sharedLinks.public` controls the authenticated user's ability to toggle "share with everyone." `ALLOW_SHARED_LINKS_PUBLIC` still controls whether those public links can be viewed without logging in.

> **Note:** For full environment variable reference, see the [.env Configuration](/v0.8.7-rc1/docs/configuration/dotenv#shared-links) page.
