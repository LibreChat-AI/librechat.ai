...
#### SearXNG
1. Follow the setup instructions in the [Web Search Configuration](/v0.8.7-rc1/docs/configuration/librechat_yaml/object_structure/web_search#setting-up-searxng) documentation
