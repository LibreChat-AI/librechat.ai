...
This page covers the **Google Custom Search** agent tool. For LibreChat's built-in **Web Search** feature (Serper/SearXNG + Firecrawl + Jina), see [Web Search](/v0.8.7-rc1/docs/features/web_search).
...
<Cards num={3}>
  ...
  <Cards.Card title="Tools Overview" href="/v0.8.7-rc1/docs/configuration/tools" arrow>
