...
If Calculator is not visible in the Agent Builder, check whether your `librechat.yaml` uses [`includedTools`](/v0.8.7-rc1/docs/configuration/librechat_yaml/object_structure/config#includedtools) or [`filteredTools`](/v0.8.7-rc1/docs/configuration/librechat_yaml/object_structure/config#filteredtools).
