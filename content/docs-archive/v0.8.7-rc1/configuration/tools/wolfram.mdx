...
In LibreChat, select **Agents**, create or edit an agent, open the agent's **Tools** list, select **Wolfram**, and save the agent. See the [Agents](/v0.8.7-rc1/docs/features/agents#tools) section for more information.
