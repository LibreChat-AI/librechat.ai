...
- [MCP Features](/v0.8.7-rc1/docs/features/mcp)
- [Actions allowedAddresses](/v0.8.7-rc1/docs/configuration/librechat_yaml/object_structure/actions#allowedaddresses) (similar concept for Actions)
