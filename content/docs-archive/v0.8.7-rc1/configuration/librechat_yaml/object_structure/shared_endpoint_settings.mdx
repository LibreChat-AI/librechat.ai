...
This page describes the shared configuration settings for all endpoints. The settings highlighted here are available to all configurations under the ["Endpoints"](/v0.8.7-rc1/docs/configuration/librechat_yaml/object_structure/config#endpoints) field unless noted otherwise.
...
- `anthropic`
- `bedrock`
- For custom endpoints: use the exact [custom endpoint name](/v0.8.7-rc1/docs/configuration/librechat_yaml/object_structure/custom_endpoint#name)
...
- [Custom Endpoints](/v0.8.7-rc1/docs/configuration/librechat_yaml/object_structure/custom_endpoint)
- [OpenAI](/v0.8.7-rc1/docs/configuration/pre_configured_ai/openai)
- [Anthropic](/v0.8.7-rc1/docs/configuration/pre_configured_ai/anthropic)
- [Bedrock](/v0.8.7-rc1/docs/configuration/pre_configured_ai/bedrock)
- [Google](/v0.8.7-rc1/docs/configuration/pre_configured_ai/google)
- [Azure OpenAI](/v0.8.7-rc1/docs/configuration/librechat_yaml/object_structure/azure_openai)
- [Assistants](/v0.8.7-rc1/docs/configuration/librechat_yaml/object_structure/assistants_endpoint)
