...
- LibreChat installed and running (see [Docker setup](/v0.8.7-rc1/docs/local/docker))
- A `librechat.yaml` file created and mounted (see [librechat.yaml guide](/v0.8.7-rc1/docs/configuration/librechat_yaml))
...
<Cards num={2}>
  <Cards.Card title="Custom Endpoint Fields" href="/v0.8.7-rc1/docs/configuration/librechat_yaml/object_structure/custom_endpoint" arrow>
    All available fields for custom endpoint configuration
  </Cards.Card>
  <Cards.Card title="Full Example Config" href="/v0.8.7-rc1/docs/configuration/librechat_yaml/example" arrow>
