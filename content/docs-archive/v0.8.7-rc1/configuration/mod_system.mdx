...
**For further details, refer to the user guide provided here: [Automated Moderation](/v0.8.7-rc1/docs/features/mod_system)**
...
**Note:** currently, most of these values are configured through the .env file, but they may soon migrate to be exclusively configured from the [`librechat.yaml` config file](/v0.8.7-rc1/docs/configuration/librechat_yaml/object_structure/config#ratelimits).
