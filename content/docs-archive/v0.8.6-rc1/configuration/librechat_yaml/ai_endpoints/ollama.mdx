...
Note: Once `stop` was removed from the [default parameters](/v0.8.6-rc1/docs/configuration/librechat_yaml/object_structure/default_params), the issue highlighted below should no longer exist.
