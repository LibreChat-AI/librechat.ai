...
5. Replace `<db_username>` and `<db_password>` in the connection string with the username password you set in Step 6. Remove the `<>` characters around the password.
