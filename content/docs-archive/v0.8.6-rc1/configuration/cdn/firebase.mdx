...
For more information about the `librechat.yaml` config file, see the guide here: [Custom Endpoints & Configuration](/v0.8.6-rc1/docs/configuration/librechat_yaml).
