...
See the [environment variable reference](/v0.8.8-rc2/docs/configuration/dotenv#security-headers-and-content-security-policy) for where these settings live in `.env`.
