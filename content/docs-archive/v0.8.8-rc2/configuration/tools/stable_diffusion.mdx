...
In LibreChat, select **Agents**, create or edit an agent, open the agent's **Tools** list, select **Stable Diffusion**, and save the agent. See the [Agents](/v0.8.8-rc2/docs/features/agents#tools) section for more information.
