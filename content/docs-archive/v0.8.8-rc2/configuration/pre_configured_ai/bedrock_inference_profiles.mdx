...
4. **LibreChat** with Bedrock endpoint configured (see [AWS Bedrock Setup](/v0.8.8-rc2/docs/configuration/pre_configured_ai/bedrock))
...
Add the `bedrock` endpoint configuration to your `librechat.yaml`. For full field reference, see [AWS Bedrock Object Structure](/v0.8.8-rc2/docs/configuration/librechat_yaml/object_structure/aws_bedrock).
...
- [AWS Bedrock Object Structure](/v0.8.8-rc2/docs/configuration/librechat_yaml/object_structure/aws_bedrock) - YAML config field reference
- [AWS Bedrock Setup](/v0.8.8-rc2/docs/configuration/pre_configured_ai/bedrock) - Basic Bedrock configuration
