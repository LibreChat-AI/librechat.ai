...
For detailed Auth0 configuration, see: [Auth0 OpenID Connect Configuration](/v0.8.8-rc2/docs/configuration/authentication/OAuth2-OIDC/auth0)
...
<Callout type="info" title="Microsoft Graph API Integration">
  ...
  Integration](/v0.8.8-rc2/docs/configuration/authentication/OAuth2-OIDC/azure#advanced-microsoft-graph-api-integration)
  for more details.
</Callout>
