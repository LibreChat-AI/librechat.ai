...
- `dropParams: ["top_p"]` is required. Without it, requests fail because Huggingface rejects the `top_p` parameter. See [`dropParams`](/v0.8.8-rc2/docs/configuration/librechat_yaml/object_structure/custom_endpoint#dropparams).
