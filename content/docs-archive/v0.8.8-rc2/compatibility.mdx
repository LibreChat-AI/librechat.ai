...
- **Custom (OpenAI-compatible)** covers any provider configured through
  [custom endpoints](/v0.8.8-rc2/docs/configuration/librechat_yaml/ai_endpoints), such as
...
- **Agents** is the most capable endpoint: it adds tool use,
  [MCP](/v0.8.8-rc2/docs/features/mcp), [Code Interpreter](/v0.8.8-rc2/docs/features/code_interpreter),
  file search, and [Image Generation](/v0.8.8-rc2/docs/features/image_gen) on top of most
