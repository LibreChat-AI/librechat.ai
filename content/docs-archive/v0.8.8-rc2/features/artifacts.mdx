...
1. Create or edit an [Agent](/v0.8.8-rc2/docs/features/agents).
...
Agent-level configuration is preferred because each agent can use the mode and instructions appropriate to its purpose. The administrator can hide Artifacts by removing the `artifacts` [agent capability](/v0.8.8-rc2/docs/configuration/librechat_yaml/object_structure/agents#capabilities).
