...
Use the sidebar toggle to open or collapse the navigation. Select a panel from the navigation rail, use conversation search when it is configured, or choose **New chat** to start a conversation. Projects have their own sidebar section and scoped new-chat shortcuts; see [Projects](/v0.8.8-rc2/docs/features/projects).
