...
> **Note:** The preferred way to use artifacts is now through the [Agents feature](/v0.8.6/docs/features/agents#artifacts), which allows for more granular control by enabling/disabling artifacts at the agent level rather than app-wide.
