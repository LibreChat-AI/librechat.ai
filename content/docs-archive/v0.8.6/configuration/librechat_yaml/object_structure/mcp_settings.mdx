...
- [MCP Features](/v0.8.6/docs/features/mcp)
- [Actions allowedAddresses](/v0.8.6/docs/configuration/librechat_yaml/object_structure/actions#allowedaddresses) (similar concept for Actions)
