...
For a quick overview, refer to the user guide provided here: [Authentication](/v0.8.6/docs/features/authentication)
...
To set up the mod system, review [the setup guide](/v0.8.6/docs/configuration/mod_system).
