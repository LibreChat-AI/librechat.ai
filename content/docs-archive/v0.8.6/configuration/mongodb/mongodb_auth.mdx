...
For more info about the override file, please consult: [Docker Compose Override](/v0.8.6/docs/configuration/docker_override)
...
Example `docker-compose.override.yml` file using the [`librechat.yaml` config file](/v0.8.6/docs/configuration/librechat_yaml), [MongoDB Authentication](/v0.8.6/docs/configuration/mongodb/mongodb_auth), and `mongo-express` for [managing your MongoDB database](/blog/2023-11-30_mongoexpress):
