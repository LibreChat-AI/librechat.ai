...
- [Apple](/v0.8.2/docs/configuration/authentication/OAuth2-OIDC/apple)
- [Discord](/v0.8.2/docs/configuration/authentication/OAuth2-OIDC/discord)
- [Facebook](/v0.8.2/docs/configuration/authentication/OAuth2-OIDC/facebook)
- [GitHub](/v0.8.2/docs/configuration/authentication/OAuth2-OIDC/github)
- [Google](/v0.8.2/docs/configuration/authentication/OAuth2-OIDC/google)
...
- [Re-use OpenID Tokens for Login Session](/v0.8.2/docs/configuration/authentication/OAuth2-OIDC/token-reuse)
