...
Redis enables [Resumable Streams](/v0.8.2/docs/features/resumable_streams) for horizontally scaled deployments. When enabled, AI responses can seamlessly reconnect and resume across server instances.
...
See [Resumable Streams](/v0.8.2/docs/features/resumable_streams) for more details on this feature.