...
**Note:** To enable `azureAssistants`, see the [Azure OpenAI Configuration](/v0.8.4-rc1/docs/configuration/azure#using-assistants-with-azure) for more information.
