...
- **Notes**:
  ...
  - Please refer to the [File Storage & CDN documentation](/v0.8.4-rc1/docs/configuration/cdn) for setup details
...
- **Notes**:
  ...
  - Please refer to the [File Storage & CDN documentation](/v0.8.4-rc1/docs/configuration/cdn) for setup details for each storage provider
...
see: [OCR Config Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/ocr)
...
see: [Web Search Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/web_search)
...
see: [File Config Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/file_config)
...
see also: 
- [socialLogins](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/registration#sociallogins),
- [alloweddomains](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/registration#alloweddomains),
- [Registration Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/registration)
...
see: [Memory Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/memory)
...
see also: 
- [alloweddomains](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/actions#alloweddomains),
- [Actions Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/actions)
...
see: [Interface Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/interface)
...
see: [Model Specs Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/model_specs)
...
see: [MCP Settings Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/mcp_settings)
...
- **Notes**:
  ...
  - see: [MCP Servers Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/mcp_servers)
...
see: [Speech Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/speech)
...
see: [Turnstile Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/turnstile)
...
see: [Transactions Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/transactions)

## Additional links
- [AWS Bedrock Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/aws_bedrock)
- [Custom Endpoint Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/custom_endpoint)
- [Azure OpenAI Endpoint Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/azure_openai)
- [Assistants Endpoint Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/assistants_endpoint)
- [Agents](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/agents)
- [OCR Config Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/ocr)
- [Speech Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/speech)
- [Turnstile Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/turnstile)
- [Transactions Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/transactions)
- [Balance Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/balance)
- [Web Search Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/web_search)
- [Memory Object Structure](/v0.8.4-rc1/docs/configuration/librechat_yaml/object_structure/memory)
