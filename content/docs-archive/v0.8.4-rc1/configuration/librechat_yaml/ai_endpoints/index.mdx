...
- This section lists known, compatible AI Endpoints, also known as "Custom Endpoints," with example setups for the `librechat.yaml` file, also known as the [Custom Config](/v0.8.4-rc1/docs/configuration/librechat_yaml) file.
...
- It's recommended you follow the [Custom Endpoints Quick Start Guide](/v0.8.4-rc1/docs/quick_start/custom_endpoints) before proceeding with the examples below.
- Important: make sure you setup the `librechat.yaml` file correctly: **[setup documentation](/v0.8.4-rc1/docs/configuration/librechat_yaml/setup)**.
