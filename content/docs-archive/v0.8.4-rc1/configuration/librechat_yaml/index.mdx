...
Future updates will streamline configuration further by migrating some settings from your [.env file](/v0.8.4-rc1/docs/configuration/dotenv) to `librechat.yaml`.
