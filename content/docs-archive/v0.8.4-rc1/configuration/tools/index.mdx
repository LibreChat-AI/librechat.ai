...
### Azure AI Search
- [Azure AI Search](/v0.8.4-rc1/docs/configuration/tools/azure_ai_search)

### Google Search
- [Google Search](/v0.8.4-rc1/docs/configuration/tools/google_search)

### OpenWeather
- [OpenWeather](/v0.8.4-rc1/docs/configuration/tools/openweather)

### Stable Diffusion
- [Stable Diffusion](/v0.8.4-rc1/docs/features/image_gen#3--stable-diffusion-local)

### Flux
- [Flux Image Generation](/v0.8.4-rc1/docs/features/image_gen#4--flux)

### Wolfram|Alpha
- [Wolfram|Alpha](/v0.8.4-rc1/docs/configuration/tools/wolfram)
