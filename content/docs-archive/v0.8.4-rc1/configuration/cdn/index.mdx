...
### Amazon S3
- [Amazon S3](/v0.8.4-rc1/docs/configuration/cdn/s3)

### Azure Blob Storage
- [Azure Blob Storage](/v0.8.4-rc1/docs/configuration/cdn/azure)

## CDN

### Firebase
- [Firebase CDN](/v0.8.4-rc1/docs/configuration/cdn/firebase)
