...
- **[AWS Bedrock](/v0.8.3-rc1/docs/configuration/pre_configured_ai/bedrock)**
...
- **[Assistants](/v0.8.3-rc1/docs/configuration/pre_configured_ai/assistants)**
    - Enable and configure OpenAI's Assistants

## Custom Endpoint Configuration

The **[librechat.yaml Configuration Guides](/v0.8.3-rc1/docs/configuration/librechat_yaml)** provides detailed instructions on how to configure custom endpoints within LibreChat.
