...
**Notes:**
- This is required to be `true` if using [`modelSpecs.addedEndpoints`](/v0.8.3-rc1/docs/configuration/librechat_yaml/object_structure/model_specs#addedendpoints).
...
**Note:** This controls the UI visibility of the memories feature. For detailed memory behavior configuration (token limits, personalization, agent settings), see the [Memory Configuration](/v0.8.3-rc1/docs/configuration/librechat_yaml/object_structure/memory).
...
More info on [Agents](/v0.8.3-rc1/docs/features/agents)
...
Enables/disables the "Run Code" button for Markdown Code Blocks. More info on the [LibreChat Code Interpreter API](/v0.8.3-rc1/docs/features/code_interpreter)

**Note:** This setting does not disable the [Agents Code Interpreter Capability](/v0.8.3-rc1/docs/features/agents#code-interpreter). To disable the Agents Capability, see the [Agents Endpoint configuration](/v0.8.3-rc1/docs/configuration/librechat_yaml/object_structure/agents) instead.
...
Enables/disables the web search button in the chat interface. More info on [Web Search Configuration](/v0.8.3-rc1/docs/configuration/librechat_yaml/object_structure/web_search)

**Note:** This setting does not disable the [Agents Web Search Capability](/v0.8.3-rc1/docs/features/agents#web-search). To disable the Agents Capability, see the [Agents Endpoint configuration](/v0.8.3-rc1/docs/configuration/librechat_yaml/object_structure/agents) instead.
...
**Note:** This setting does not disable the [Agents File Search Capability](/v0.8.3-rc1/docs/features/agents#file-search). To disable the Agents Capability, see the [Agents Endpoint configuration](/v0.8.3-rc1/docs/configuration/librechat_yaml/object_structure/agents) instead.
...
- When using agents with file search capability, citation behavior (quantity and quality) can be configured through the [Agents endpoint configuration](/v0.8.3-rc1/docs/configuration/librechat_yaml/object_structure/agents#file-citation-configuration-examples).
