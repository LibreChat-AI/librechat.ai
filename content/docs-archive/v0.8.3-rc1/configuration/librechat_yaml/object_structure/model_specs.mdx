...
**Note:** If you are using a custom endpoint, the `endpoint` value must match the defined [custom endpoint name](/v0.8.3-rc1/docs/configuration/librechat_yaml/object_structure/custom_endpoint#name) exactly.
...
For more information about the ACL permissions system, see the [Agents documentation](/v0.8.3-rc1/docs/features/agents#migration-required-v080-rc3).
</Callout>
