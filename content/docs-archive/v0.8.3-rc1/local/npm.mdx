...
- MongoDB (Atlas or Community Server)
  - [MongoDB Atlas](/v0.8.3-rc1/docs/configuration/mongodb/mongodb_atlas)
  - [MongoDB Community Server](/v0.8.3-rc1/docs/configuration/mongodb/mongodb_community)
...
**see also:**
- [User Authentication System Setup](/v0.8.3-rc1/docs/configuration/authentication)
- [AI Setup](/v0.8.3-rc1/docs/configuration/pre_configured_ai)
- [Custom Endpoints & Configuration](/v0.8.3-rc1/docs/configuration/librechat_yaml)