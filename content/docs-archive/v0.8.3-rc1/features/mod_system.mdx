...
- `Optional:` Text-to-Speech (TTS) limiting (configurable through [`librechat.yaml` config file](/v0.8.3-rc1/docs/configuration/librechat_yaml/object_structure/config#ratelimits))
- `Optional:` Speech-to-Text (STT) limiting (configurable through [`librechat.yaml` config file](/v0.8.3-rc1/docs/configuration/librechat_yaml/object_structure/config#ratelimits))
- `Optional:` File Upload limiting (configurable through [`librechat.yaml` config file](/v0.8.3-rc1/docs/configuration/librechat_yaml/object_structure/config#ratelimits))

**For further details, refer to the configuration guide provided here: [Automated Moderation](/v0.8.3-rc1/docs/configuration/mod_system)**