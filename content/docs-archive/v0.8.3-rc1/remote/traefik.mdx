...
```
  ...
  see: [Docker Override](/v0.8.3-rc1/docs/configuration/docker_override) for more info.
...
For more information on static file handling in LibreChat, including caching options, refer to the [Static File Handling](/v0.8.3-rc1/docs/configuration/dotenv#static-file-handling) documentation.
