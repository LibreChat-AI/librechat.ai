...
- See the [Upload as Text](/v0.8.5/docs/features/upload_as_text) documentation for details.
...
For more details on Bedrock configuration, see the [AWS Bedrock setup guide](/v0.8.5/docs/configuration/pre_configured_ai/bedrock).
</Callout>

## Detailed Configuration

For additional, detailed configuration options, see the [OCR Config Object Structure](/v0.8.5/docs/configuration/librechat_yaml/object_structure/ocr).
...
For more details on file processing configuration, see [File Config Object Structure](/v0.8.5/docs/configuration/librechat_yaml/object_structure/file_config).
...
For temporary document questions in chat, see [Upload as Text](/v0.8.5/docs/features/upload_as_text).
...
For more information on configuring OCR, see the [OCR Config Object Structure](/v0.8.5/docs/configuration/librechat_yaml/object_structure/ocr).
