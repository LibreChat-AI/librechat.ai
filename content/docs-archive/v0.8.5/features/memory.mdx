...
The provider field should match the accepted values as defined in the [Model Spec Guide](/v0.8.5/docs/configuration/librechat_yaml/object_structure/model_specs#endpoint).

**Note:** If you are using a custom endpoint, the endpoint value must match the defined custom endpoint name exactly.

See the [Memory Configuration Guide](/v0.8.5/docs/configuration/librechat_yaml/object_structure/memory) for detailed configuration options.
...
For valid model parameters per provider, see the [Model Spec Preset Fields](/v0.8.5/docs/configuration/librechat_yaml/object_structure/model_specs#preset-fields).
...
- All [custom endpoint headers](/v0.8.5/docs/configuration/librechat_yaml/object_structure/custom_endpoint#headers) are supported
...
- [Agents](/v0.8.5/docs/features/agents) - Build custom AI assistants
- [Presets](/v0.8.5/docs/user_guides/presets) - Save conversation settings
- [Fork Messages](/v0.8.5/docs/features/fork) - Branch conversations while maintaining context 