...
This page covers the **Google Custom Search** tool (agent plugin). For LibreChat's built-in **Web Search** feature (Serper/SearXNG + Firecrawl + Jina), see [Web Search](/v0.8.5/docs/features/web_search).
...
<Cards num={3}>
  ...
  <Cards.Card title="Tools Overview" href="/v0.8.5/docs/configuration/tools" arrow>
