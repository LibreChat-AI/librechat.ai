...
To learn more about this feature and how to configure it, see [Re-use OpenID Tokens for Login Session](/v0.8.5/docs/configuration/authentication/OAuth2-OIDC/token-reuse).
...
For detailed troubleshooting and advanced configuration, see: [SharePoint Integration Guide](/v0.8.5/docs/configuration/sharepoint)
