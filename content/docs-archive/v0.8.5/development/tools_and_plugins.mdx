...
**This page is deprecated. Please refer to the [Agents Guide](/v0.8.5/docs/features/agents) for the most up-to-date information on using tools.**

**It is highly recommend to use the [Model Context Protocol](/v0.8.5/docs/features/agents#model-context-protocol-mcp) or [OpenAPI Actions](/v0.8.5/docs/features/agents#actions) for integrating custom tools**
