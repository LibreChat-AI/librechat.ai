...
Firebase Storage integrates with Firebase Hosting's global CDN, letting you serve files stored in Firebase Storage through edge locations around the world. It is one of LibreChat's CDN-backed file storage options, alongside [CloudFront for S3](/v0.8.7/docs/configuration/cdn/cloudfront).
...
For more about this file, see the [librechat.yaml guide](/v0.8.7/docs/configuration/librechat_yaml).
