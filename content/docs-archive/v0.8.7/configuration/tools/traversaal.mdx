...
- If the tool is not visible in the Agent Builder, check [`includedTools`](/v0.8.7/docs/configuration/librechat_yaml/object_structure/config#includedtools), [`filteredTools`](/v0.8.7/docs/configuration/librechat_yaml/object_structure/config#filteredtools), and the agent's `tools` capability.
