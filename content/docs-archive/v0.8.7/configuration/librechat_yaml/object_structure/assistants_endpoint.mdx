...
**Note:** To enable `azureAssistants`, see the [Azure OpenAI Configuration](/v0.8.7/docs/configuration/librechat_yaml/ai_endpoints/azure#using-assistants-with-azure) for more information.
