...
- [Apple](/v0.8.7/docs/configuration/authentication/OAuth2-OIDC/apple)
- [Discord](/v0.8.7/docs/configuration/authentication/OAuth2-OIDC/discord)
- [Facebook](/v0.8.7/docs/configuration/authentication/OAuth2-OIDC/facebook)
- [GitHub](/v0.8.7/docs/configuration/authentication/OAuth2-OIDC/github)
- [Google](/v0.8.7/docs/configuration/authentication/OAuth2-OIDC/google)
...
- [Re-use OpenID Tokens for Login Session](/v0.8.7/docs/configuration/authentication/OAuth2-OIDC/token-reuse)
...
If the Admin Panel is hosted on a separate URL from LibreChat, set [`ADMIN_PANEL_URL`](/v0.8.7/docs/features/admin_panel#librechat-redirect-url) in the LibreChat API environment. This tells LibreChat where to send admins after the admin OAuth or SSO callback completes.
