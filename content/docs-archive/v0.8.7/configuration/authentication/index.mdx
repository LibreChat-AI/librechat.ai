...
For a quick overview, refer to the user guide provided here: [Authentication](/v0.8.7/docs/features/authentication)
...
To set up the mod system, review [the setup guide](/v0.8.7/docs/configuration/mod_system).
...
2. For the `deploy-compose.yml` (if you followed the [Ubuntu Docker Guide](/v0.8.7/docs/remote/docker_linux)):
   ```bash
