...
- [Azure Entra Authentication](/v0.8.7/docs/configuration/authentication/OAuth2-OIDC/azure)
- [OpenID Token Reuse](/v0.8.7/docs/configuration/authentication/OAuth2-OIDC/token-reuse)
- [Microsoft Graph API Integration](/v0.8.7/docs/configuration/authentication/OAuth2-OIDC/azure#advanced-microsoft-graph-api-integration)
- [File Upload Configuration](/v0.8.7/docs/configuration/librechat_yaml/object_structure/file_config)
