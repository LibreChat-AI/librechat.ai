...
Meilisearch is an open-source search engine that powers LibreChat's conversation search, adding full-text search, typo tolerance, and instant results across past conversations. For a feature overview, see [Search in LibreChat](/v0.8.7/docs/features/search).
...
See [Docker Override](/v0.8.7/docs/configuration/docker_override) for how override files are merged.
