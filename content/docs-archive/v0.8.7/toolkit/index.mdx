...
<Cards num={2}>
  <Card title="Credentials Generator" href="/v0.8.7/docs/toolkit/credentials-generator" arrow>
    Generate secure random values for CREDS_KEY, JWT_SECRET, and other .env variables.
  </Card>
  <Card title="YAML Validator" href="/v0.8.7/docs/toolkit/yaml-validator" arrow>
