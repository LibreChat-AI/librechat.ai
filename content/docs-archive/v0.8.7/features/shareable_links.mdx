...
- **`SHARED_LINKS_SNAPSHOT_FILES`** (default: `true`): Controls whether shared links can include referenced conversation files. This environment variable overrides [`interface.sharedLinks.snapshotFiles`](/v0.8.7/docs/configuration/librechat_yaml/object_structure/interface#sharedlinks) when set.
...
<Callout type="info">
For the full environment variable reference, see the [.env Configuration](/v0.8.7/docs/configuration/dotenv#shared-links) page.
</Callout>
