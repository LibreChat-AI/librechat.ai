...
This is a condensed version of our [Local Installation Guide](/v0.8.4/docs/local/)
...
**Notes:**
- Docker Desktop is recommended for most users. If you are looking for an advanced docker/container setup, especially for a remote server installation, see our [Ubuntu Docker Deployment Guide](/v0.8.4/docs/remote/docker_linux).
...
2. **Create and Configure .env File**:
   ...
   - Fill in any necessary values.
      - For an in-depth environment configuration, see the [.env File Configuration Guide](/v0.8.4/docs/configuration/dotenv).
