...
You can also copy the [example config](/v0.8.4/docs/configuration/librechat_yaml/example) as a starting point:
...
This uses the [docker-compose.override.yml](/v0.8.4/docs/configuration/docker_override) pattern -- Docker Compose automatically merges it with the main `docker-compose.yml`, so your customizations survive updates.
...
For the full annotated config file with more endpoint examples, see the [example configuration](/v0.8.4/docs/configuration/librechat_yaml/example).
...
<Cards num={2}>
  ...
  <Cards.Card title="Object Structure" href="/v0.8.4/docs/configuration/librechat_yaml/object_structure" arrow>
