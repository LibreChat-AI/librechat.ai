...
- See [OCR Configuration](/v0.8.4/docs/features/ocr)

**STT Processing (Optional):**
- Converts audio files to text
- Requires STT service configuration
- See [Speech-to-Text Configuration](/v0.8.4/docs/configuration/librechat_yaml/object_structure/file_config#stt)
...
**Note:** If you don't see "Upload as Text", ensure the `context` capability is enabled in your [`endpoints.agents.capabilities` configuration](/v0.8.4/docs/configuration/librechat_yaml/object_structure/agents#capabilities).
...
For more details, see [File Config Object Structure](/v0.8.4/docs/configuration/librechat_yaml/object_structure/file_config).
...
See [OCR Configuration](/v0.8.4/docs/features/ocr) for full details.
...
- See [OCR for Documents](/v0.8.4/docs/features/ocr)
...
- See [RAG API](/v0.8.4/docs/features/rag_api)
...
See [OCR Configuration](/v0.8.4/docs/configuration/librechat_yaml/object_structure/ocr) for details.

## Related Features

- [File Context](/v0.8.4/docs/features/agents#file-context) - Files used as Agent Context
- [OCR for Documents](/v0.8.4/docs/features/ocr) - Learn about and configure OCR services
- [File Configuration](/v0.8.4/docs/configuration/librechat_yaml/object_structure/file_config) - Configure file handling
