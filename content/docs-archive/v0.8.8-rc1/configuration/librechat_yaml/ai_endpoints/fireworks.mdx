...
- The API is strict for some models and may reject fields like `user`, so drop them with [`dropParams`](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/custom_endpoint#dropparams).
