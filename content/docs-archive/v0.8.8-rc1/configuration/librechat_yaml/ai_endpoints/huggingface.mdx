...
title: Huggingface
icon: HuggingFace
description: Configure Huggingface as a custom endpoint in LibreChat.
---
...
- `dropParams: ["top_p"]` is required. Without it, requests fail because Huggingface rejects the `top_p` parameter. See [`dropParams`](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/custom_endpoint#dropparams).
