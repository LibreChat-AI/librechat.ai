...
Once `stop` was removed from the [default parameters](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/default_params), the issue below should no longer occur.
