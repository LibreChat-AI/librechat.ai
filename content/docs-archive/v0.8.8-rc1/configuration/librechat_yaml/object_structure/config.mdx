...
<OptionTable
  options={[
    ['version', 'String', 'Specifies the version of the configuration file.', 'version: 1.3.14'],
  ]}
/>
...
<OptionTable
  options={[
    [
      'langfuse',
      'Object',
      'Stores the encrypted Langfuse connection managed through LibreChat configuration APIs.',
      '',
    ],
  ]}
/>
...
see: [Skill Sync Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/skill_sync)
...
<OptionTable
  options={[
    [
      'messageFilter',
      'Object',
      'Configures server-side message filters. In v1.3.13, `messageFilter.pii` can reject credential-shaped submitted text before model calls and persistence.',
      '',
    ],
  ]}
/>

see: [Message Filter Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/message_filter)
...
- **Notes**:
  ...
  - Please refer to the [File Storage & CDN documentation](/v0.8.8-rc1/docs/configuration/cdn) for setup details
...
- **Notes**:
  ...
  - Please refer to the [File Storage & CDN documentation](/v0.8.8-rc1/docs/configuration/cdn) for setup details for each storage provider
...
see: [CloudFront Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/cloudfront) and [CloudFront with S3](/v0.8.8-rc1/docs/configuration/cdn/cloudfront)
...
see: [OCR Config Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/ocr)
...
see: [Web Search Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/web_search)
...
see: [File Config Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/file_config)
...
- [socialLogins](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/registration#sociallogins),
- [alloweddomains](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/registration#alloweddomains),
- [Registration Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/registration)
...
see: [Memory Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/memory)
...
see: [Summarization Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/summarization)
...
- [allowedDomains](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/actions#alloweddomains),
- [allowedAddresses](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/actions#allowedaddresses),
- [Actions Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/actions)
...
/>
see: [Interface Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/interface)
...
see: [Model Specs Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/model_specs)
...
see: [MCP Settings Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/mcp_settings)
...
- **Notes**:
  ...
  - see: [MCP Servers Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/mcp_servers)
...
Both `speech.tts` and `speech.stt` accept an `allowedAddresses` array of trusted private host:port exemptions. Speech requests enforce the default private-address block at connect time. See the detailed [Speech reference](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/speech#ssrf-protection) for entry rules, proxy behavior, and examples.

see: [Speech Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/speech)
...
see: [Turnstile Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/turnstile)
...
see: [Transactions Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/transactions)

## Additional links

- [Summarization Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/summarization)
- [AWS Bedrock Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/aws_bedrock)
- [Custom Endpoint Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/custom_endpoint)
- [Azure OpenAI Endpoint Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/azure_openai)
- [Assistants Endpoint Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/assistants_endpoint)
- [Agents](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/agents)
- [OCR Config Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/ocr)
- [Speech Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/speech)
- [Turnstile Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/turnstile)
- [Transactions Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/transactions)
- [Balance Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/balance)
- [Web Search Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/web_search)
- [Memory Object Structure](/v0.8.8-rc1/docs/configuration/librechat_yaml/object_structure/memory)
