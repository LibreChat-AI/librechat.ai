...
<Callout type="info" title="Development Resources">
  ...
  - Use **[Contributor Setup](/v0.8.8-rc1/docs/development/get_started)** for the full local setup flow.
  - Use **[Code Standards and Conventions](/v0.8.8-rc1/docs/development/conventions)** for workspace boundaries, import order, typing, testing, and frontend rules.
</Callout>
