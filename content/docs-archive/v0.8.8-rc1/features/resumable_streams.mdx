...
- [Redis Configuration](/v0.8.8-rc1/docs/configuration/redis): setting up Redis for caching and horizontal scaling
- [Agents](/v0.8.8-rc1/docs/features/agents): AI agents with tool use
- [Docker Deployment](/v0.8.8-rc1/docs/local/docker): container-based deployment
