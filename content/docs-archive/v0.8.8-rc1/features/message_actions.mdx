...
Use **Fork** to branch a conversation from a selected message. See [Forking Conversations](/v0.8.8-rc1/docs/features/fork) for details. Endpoint and message state determine whether edit, rerun, continue, feedback, read-aloud, and fork actions are available.
