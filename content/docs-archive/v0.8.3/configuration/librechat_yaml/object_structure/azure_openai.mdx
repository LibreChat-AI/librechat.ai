...
**[For a detailed guide on setting up Azure OpenAI configurations, click here](/v0.8.3/docs/configuration/azure)**
...
> **Note:** Azure OpenAI endpoint supports all [Shared Endpoint Settings](/v0.8.3/docs/configuration/librechat_yaml/object_structure/shared_endpoint_settings), including `streamRate`, `titleModel`, `titleMethod`, `titlePrompt`, `titlePromptTemplate`, and `titleEndpoint`.
