...
```
- If using a [custom endpoint](/v0.8.3/docs/quick_start/custom_endpoints), you can use its name as the value (case-insensitive)
...
- `spec`: Select a specific LibreChat [Model Spec](/v0.8.3/docs/configuration/librechat_yaml/object_structure/model_specs) by name
...
For more information on any of the above, refer to [Model Spec Preset Fields](/v0.8.3/docs/configuration/librechat_yaml/object_structure/model_specs), which shares most parameters.
