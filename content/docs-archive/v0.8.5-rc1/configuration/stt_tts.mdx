...
> **See Also:** For detailed YAML configuration schema and all available options, see the [Speech Object Structure](/v0.8.5-rc1/docs/configuration/librechat_yaml/object_structure/speech) documentation.
