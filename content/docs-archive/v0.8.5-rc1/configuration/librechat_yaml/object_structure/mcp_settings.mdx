...
- [MCP Features](/v0.8.5-rc1/docs/features/mcp)
- [Actions allowedDomains](/v0.8.5-rc1/docs/configuration/librechat_yaml/object_structure/actions#alloweddomains) (similar concept for Actions)
