...
If you want to make sure Docker can use your `librechat.yaml` file for [Custom Endpoints & Configuration](/v0.8.5-rc1/docs/configuration/librechat_yaml), it would look like this:
