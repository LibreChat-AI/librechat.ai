...
LibreChat comes with **built-in image tools** that you can add to an **[Agent](/v0.8.5-rc1/docs/features/agents).**
...
More details can be found in the dedicated [Gemini Image Gen guide](/v0.8.5-rc1/docs/configuration/tools/gemini_image_gen).
...
More details on setting up Automatic1111 can be found in the dedicated [Stable Diffusion guide](/v0.8.5-rc1/docs/configuration/tools/stable_diffusion).
...
More details can be found in the dedicated [Flux guide](/v0.8.5-rc1/docs/configuration/tools/flux#parameters).
...
1. Saved according to the configured [**`fileStrategy`**](/v0.8.5-rc1/docs/configuration/librechat_yaml/object_structure/config#filestrategy)
...
<Cards num={3}>
  <Cards.Card title="Agents" href="/v0.8.5-rc1/docs/features/agents" arrow>
    Create and configure AI agents with custom tools
  </Cards.Card>
  <Cards.Card title="MCP Servers" href="/v0.8.5-rc1/docs/features/mcp" arrow>
    Bring your own tools via Model Context Protocol
  </Cards.Card>
  <Cards.Card title="Gemini Image Tools" href="/v0.8.5-rc1/docs/configuration/tools/gemini_image_gen" arrow>
