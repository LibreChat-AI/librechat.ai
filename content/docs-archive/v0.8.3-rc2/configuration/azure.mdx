...
Here's another working example configured according to the specifications of the [Azure OpenAI Endpoint Configuration Docs:](/v0.8.3-rc2/docs/configuration/librechat_yaml/object_structure/azure_openai)
...
The list of models available to your users are determined by the model groupings specified in your [`azureOpenAI` endpoint config.](/v0.8.3-rc2/docs/configuration/librechat_yaml/object_structure/azure_openai)
...
This will work seamlessly as it does with the [OpenAI endpoint](/v0.8.3-rc2/docs/configuration/pre_configured_ai/openai) (no need to select the vision model, it will be switched behind the scenes)
