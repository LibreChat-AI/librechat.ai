...
Future updates will streamline configuration further by migrating some settings from your [.env file](/v0.8.3-rc2/docs/configuration/dotenv) to `librechat.yaml`.
