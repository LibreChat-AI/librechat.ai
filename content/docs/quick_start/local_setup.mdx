...
1. **Go to the Project Page**: Visit [https://github.com/LibreChat-AI/LibreChat](https://github.com/LibreChat-AI/LibreChat).
...
LibreChat is now running, but it needs an account and a model before it can answer anything:
...
Follow [Your First Chat](/docs/quick_start/first_chat) for these steps in detail, including what to do when no model answers.
