...
- Si `skills_enabled` est défini sur true et qu'aucune liste d'autorisation de compétences (skill allowlist) n'est définie, l'agent peut utiliser le catalogue actif complet visible par l'utilisateur, y compris les compétences ajoutées ultérieurement.
...
Dans l'Agent Builder, activez **Use all skills** pour utiliser le catalogue complet. Le désactiver restaure la sélection de compétences qui était active avant que l'option ne soit activée.
