...
Ngoài `USER` và `ADMIN`, quản trị viên có thể tạo **các vai trò tùy chỉnh** với ma trận quyền tính năng riêng (được giới thiệu từ phiên bản v0.8.5; xem [#12528](https://github.com/LibreChat-AI/LibreChat/pull/12528)). Một người dùng có thể nắm giữ nhiều vai trò và các quyền hiệu dụng của họ là sự hợp nhất từ tất cả các vai trò đang nắm giữ. Các vai trò tùy chỉnh được quản lý từ bảng điều khiển quản trị.
...
Ngoài các cờ tính năng, phiên bản v0.8.5 đã giới thiệu hệ thống **ghi đè cấu hình dựa trên DB** ([#12354](https://github.com/LibreChat-AI/LibreChat/pull/12354)). Hệ thống này cho phép bạn chỉ định một _cấu hình kiểu `librechat.yaml` khác_ cho các nhóm hoặc vai trò cụ thể. Ví dụ: một nhóm "Nghiên cứu" có thể có quyền truy cập vào các endpoint bổ sung, giới hạn đệ quy cao hơn và các khả năng tác nhân khác so với cấu hình mặc định. Các ghi đè được giải quyết khi đăng nhập và được kết hợp trên cấu hình cơ sở.
