...
以下は、[Replicate API](https://replicate.com/account/api-tokens) を使用して画像を出力する [Image Generation server](https://github.com/GongRzhe/Image-Generation-MCP-Server) の例ですが、MCPの画像レスポンス標準に準拠していない画像のURLを返します。
