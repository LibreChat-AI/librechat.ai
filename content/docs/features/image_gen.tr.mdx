...
Aşağıdaki örnek, [Replicate API](https://replicate.com/account/api-tokens) kullanarak görseller oluşturan ancak MCP'nin görsel yanıt standardına uymayan görsel URL'leri döndüren bir [Image Generation server](https://github.com/GongRzhe/Image-Generation-MCP-Server) örneğidir.
