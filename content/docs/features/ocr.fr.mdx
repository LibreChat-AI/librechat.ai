...
- LibreChat n'inclut actuellement pas le contenu image analysé provenant du processus OCR dans ses réponses, bien que des services comme [l'API OCR de Mistral puissent fournir](https://docs.mistral.ai/api/#tag/ocr) ces éléments dans le résultat. Cette fonctionnalité pourrait être prise en charge dans de futures mises à jour.
