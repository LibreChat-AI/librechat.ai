...
Jeśli uruchamiasz LibreChat przy użyciu oficjalnego pliku [`docker-compose.yml`](https://github.com/LibreChat-AI/LibreChat/blob/main/docker-compose.yml) lub [`deploy-compose.yml`](https://github.com/LibreChat-AI/LibreChat/blob/main/deploy-compose.yml), panel administratora jest dostarczany jako usługa i uruchamia się automatycznie wraz z LibreChat -- nie jest wymagane oddzielne wdrażanie.
...
To jest interfejs stojący za [opartym na bazie danych systemem nadpisywania konfiguracji dla poszczególnych podmiotów](https://github.com/LibreChat-AI/LibreChat/pull/12354) w LibreChat. Typowe przypadki użycia:
