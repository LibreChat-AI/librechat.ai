...
Los servidores MCP que emiten `notifications/tools/list_changed` pueden actualizar su catálogo de herramientas sin necesidad de reiniciar LibreChat. LibreChat obtiene la lista actual desde la conexión activa, publica las herramientas añadidas y deja de anunciar las herramientas que el servidor eliminó. Las reconexiones también sincronizan el catálogo antes de que la conexión sea considerada como lista.
