...
Per gli endpoint Google, imposta `url_context=true` per consentire ai modelli di testo Gemini supportati di leggere gli URL inclusi nel messaggio dell'utente. Gli URL di YouTube vengono gestiti con la comprensione video nativa quando URL Context è abilitato.
