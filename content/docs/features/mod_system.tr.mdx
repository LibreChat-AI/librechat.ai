...
- `Optional:` Eşzamanlı Mesaj sınırlaması (kullanıcı başına aynı anda yalnızca X mesaj)
...
- `Optional:` Sohbet çatallama (forking) sınırlaması (bir kullanıcının ne sıklıkla sohbetleri çatallayabileceği, IP ve Kullanıcı bazında yapılandırılabilir)
