...
- LibreChat enthält derzeit nicht den geparsten Bildinhalt aus dem OCR-Prozess in seinen Antworten, obwohl Dienste wie [Mistral's OCR API](https://docs.mistral.ai/api/#tag/ocr) diese im Ergebnis bereitstellen könnten. Diese Funktion wird möglicherweise in zukünftigen Updates unterstützt.
