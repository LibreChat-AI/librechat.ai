...
| `fileTokenLimit` | コストとリソース使用量を制御するための、ファイル処理における最大トークン制限。リクエスト値はYAMLのデフォルトを上書きします。 |
...
詳細については、[Anthropic prompt caching docs](https://www.anthropic.com/news/prompt-caching) および [Bedrock prompt caching docs](https://docs.aws.amazon.com/bedrock/latest/userguide/prompt-caching.html#prompt-caching-get-started) を参照してください。
...
<Callout type="warning" title="クエリパラメータは慎重に使用してください">
