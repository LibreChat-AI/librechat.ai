...
Se você executar o LibreChat com o [`docker-compose.yml`](https://github.com/LibreChat-AI/LibreChat/blob/main/docker-compose.yml) ou [`deploy-compose.yml`](https://github.com/LibreChat-AI/LibreChat/blob/main/deploy-compose.yml) oficial, o painel administrativo é fornecido como um serviço e inicia automaticamente junto com o LibreChat -- nenhuma implantação separada é necessária.
...
Esta é a superfície por trás do [sistema de substituição de configuração por principal baseado em banco de dados](https://github.com/LibreChat-AI/LibreChat/pull/12354) do LibreChat. Casos de uso típicos:
