...
다음은 [Replicate API](https://replicate.com/account/api-tokens)를 사용하여 이미지를 출력하지만, MCP의 이미지 응답 표준을 따르지 않는 이미지 URL을 반환하는 [Image Generation server](https://github.com/GongRzhe/Image-Generation-MCP-Server)의 예시입니다.
