...
Para implementaciones con alta tasa de tokens, `STREAM_DELTA_COALESCE_MS=25` puede agrupar las publicaciones delta de Redis y reducir el trabajo de Redis a costa de hasta 25 ms de latencia en la entrega. Déjelo sin configurar o establézcalo en `0` para deshabilitar el procesamiento por lotes, y actívelo solo después de que cada réplica admita marcos de lote. Consulte [Stream Delta Coalescing](/docs/configuration/redis#stream-delta-coalescing).
