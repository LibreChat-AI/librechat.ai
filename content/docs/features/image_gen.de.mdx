---
title: Bildgenerierung & -bearbeitung
icon: Image
description: >-
  Umfassender Leitfaden zu den integrierten Bildgenerierungs- und
  Bearbeitungswerkzeugen von LibreChat
---
...
Erstellen oder verwenden Sie einen OpenAI-Schlüssel und fügen Sie ihn der `.env` hinzu, dann fügen Sie "OpenAI Image Tools" zur **Tools**-Liste Ihres Agenten hinzu:
...
Siehe die [GPT-Image-1 Preisseite](https://platform.openai.com/docs/models/gpt-image-1) und die [Dokumentation zur Bildgenerierung](https://platform.openai.com/docs/guides/image-generation?image-generation-model=gpt-image-1#cost-and-latency) für die Kosten der Bildgenerierung.
...
- **Duale API-Unterstützung**: Funktioniert sowohl mit einfachen Gemini API-Keys als auch mit Google Cloud Vertex AI.
...
Siehe die [DALL-E Preisübersicht](https://platform.openai.com/docs/models/dall-e-3) und die [Dokumentation zur Bildgenerierung](https://platform.openai.com/docs/guides/image-generation?image-generation-model=dall-e-3) für die Kosten der Bildgenerierung.
...
Bildausgaben werden von MCP-Servern unterstützt. Zum Beispiel kann der [Puppeteer MCP Server](https://github.com/modelcontextprotocol/servers-archived/tree/main/src/puppeteer) Screenshots von Webseiten erstellen, die das Bild im erwarteten Format ausgeben und genauso behandelt werden wie die integrierten Bild-Tools von LibreChat.
...
- Dies kann zu Problemen mit einem LLM führen, das keine Bildeingaben unterstützt. Eine Option, das Verhalten pro Agent zu deaktivieren, ist geplant.
