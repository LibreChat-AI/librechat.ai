...
如果您使用官方的 [`docker-compose.yml`](https://github.com/LibreChat-AI/LibreChat/blob/main/docker-compose.yml) 或 [`deploy-compose.yml`](https://github.com/LibreChat-AI/LibreChat/blob/main/deploy-compose.yml) 运行 LibreChat，管理面板将作为一项服务随 LibreChat 一起自动启动，无需单独部署。
...
这是 LibreChat [基于数据库的每个主体配置覆盖系统](https://github.com/LibreChat-AI/LibreChat/pull/12354)背后的实现逻辑。典型用例包括：
