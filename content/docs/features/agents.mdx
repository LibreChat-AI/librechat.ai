...
The **Tools** control opens a searchable marketplace for built-in capabilities, MCP servers, Skills, and orchestration tools. Select an item to configure it, then save the agent.
