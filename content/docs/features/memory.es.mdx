...
### Problemas de autenticación de endpoint personalizado [#custom-endpoint-authentication-issues]
...
- [Presets](/docs/user_guides/presets) - Guardar configuraciones de conversación
