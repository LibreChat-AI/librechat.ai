...
If you run LibreChat with its official [`docker-compose.yml`](https://github.com/LibreChat-AI/LibreChat/blob/main/docker-compose.yml) or [`deploy-compose.yml`](https://github.com/LibreChat-AI/LibreChat/blob/main/deploy-compose.yml), the admin panel ships as a service and starts automatically alongside LibreChat -- no separate deployment needed.
...
This is the surface behind LibreChat's [DB-backed per-principal configuration override system](https://github.com/LibreChat-AI/LibreChat/pull/12354). Typical use cases:
