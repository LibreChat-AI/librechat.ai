...
- LibreChat actualmente no incluye el contenido de imagen analizado del proceso de OCR en sus respuestas, a pesar de que servicios como [la API de OCR de Mistral pueden proporcionar](https://docs.mistral.ai/api/#tag/ocr) estos resultados. Es posible que esta funcionalidad sea compatible en futuras actualizaciones.
