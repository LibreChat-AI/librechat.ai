...
icon: Shield
description: >-
  Das automatisierte Moderationssystem verwendet einen Bewertungsmechanismus, um
  ...
  Benutzer und dessen IP-Adresse vorübergehend gesperrt. Dieses System
...
- Verstoßprotokolle finden sich im data-Ordner, der erstellt wird, sobald die Protokollierung beginnt: `librechat/data`
...
### Arten von Rate Limitern [#rate-limiter-types]
...
Verhindert den Missbrauch der Konversationsimport-Funktion, indem die Anzahl der Konversationen begrenzt wird, die innerhalb eines Zeitfensters importiert werden können. Dies hilft, Folgendes zu verhindern:
...
Steuert, wie oft Benutzer Audio zur Transkription übermitteln können. Dies verhindert:
- Übermäßige API-Nutzungskosten
...
- `Optional:` Begrenzung des Conversation-Forkings (wie oft ein Benutzer Konversationen forken kann, konfigurierbar nach IP und Benutzer)
...
**Weitere Details finden Sie im Konfigurationsleitfaden, der hier bereitgestellt wird: [Automated Moderation](/docs/configuration/mod_system)**
