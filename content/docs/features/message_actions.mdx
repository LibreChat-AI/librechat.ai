...
Enable **Copy messages as rich text** in Settings to place both plain Markdown and rendered HTML on the clipboard. Apps such as Teams, Outlook, and Word can then preserve headings, lists, tables, and code formatting when you paste.
