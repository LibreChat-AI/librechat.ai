...
Si ejecutas LibreChat con su [`docker-compose.yml`](https://github.com/LibreChat-AI/LibreChat/blob/main/docker-compose.yml) o [`deploy-compose.yml`](https://github.com/LibreChat-AI/LibreChat/blob/main/deploy-compose.yml) oficial, el panel de administración se incluye como un servicio y se inicia automáticamente junto con LibreChat; no se requiere una implementación por separado.
...
Esta es la superficie detrás del [sistema de anulación de configuración por principal respaldado por BD](https://github.com/LibreChat-AI/LibreChat/pull/12354) de LibreChat. Casos de uso típicos:
