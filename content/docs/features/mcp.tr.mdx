...
`notifications/tools/list_changed` bildirimini yayınlayan MCP sunucuları, LibreChat'i yeniden başlatmaya gerek kalmadan araç kataloglarını güncelleyebilirler. LibreChat, güncel listeyi canlı bağlantıdan çeker, eklenen araçları yayınlar ve sunucunun kaldırdığı araçların reklamını yapmayı durdurur. Yeniden bağlantılar da, bağlantı hazır kabul edilmeden önce kataloğu senkronize eder.
