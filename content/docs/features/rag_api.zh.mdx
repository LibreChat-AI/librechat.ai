...
icon: Brain
description: >-
  基于 Langchain 和 FastAPI 的检索增强生成 (RAG) API，用于文档索引和检索。此 API 与 LibreChat
  集成，可根据用户上传的文件提供上下文感知的响应。
---
...
RAG API 是 LibreChat 的一项强大功能，能够基于用户上传的文件提供具备上下文感知能力的响应。通过利用 Langchain 和 FastAPI，它提供了高效的文档索引、检索和生成能力。凭借其灵活的配置选项和无缝集成，RAG API 增强了 LibreChat 中的对话体验。
