...
<OptionTable
  options={[
    [
      'MAX_SUBAGENTS',
      'Number',
      'Subagen eksplisit maksimum per agen induk. Dapat dikonfigurasi melalui `endpoints.agents.maxSubagents`, hingga 50.',
      '10',
    ],
