...
La plupart de ces paramètres sont partagés avec les [Model Spec Preset Fields](/docs/configuration/librechat_yaml/object_structure/model_specs) ; référez-vous à cette section pour la référence complète.
