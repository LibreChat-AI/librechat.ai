...
- **Silent 401 Recovery**: If an OAuth MCP connection receives a mid-session 401 and a refresh token is available, LibreChat attempts a silent refresh before surfacing a new authentication prompt
