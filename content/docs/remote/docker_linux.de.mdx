...
Standardmäßig lädt dieses Setup die neuesten Updates des main-Branches von LibreChat herunter. Wenn Sie stattdessen die neueste "stabile" Version bevorzugen, die durch die [latest tags](https://github.com/LibreChat-AI/LibreChat/releases) definiert ist, müssen Sie die deploy-compose.yml bearbeiten und Ihre Änderungen genau wie oben in Teil V committen. Beachten Sie, dass Sie in diesem Fall nicht sofort von den neuesten Funktionen profitieren werden, sobald diese verfügbar sind.
