...
> Ces instructions + le [guide Docker](/docs/remote/docker_linux) sont conçus pour quelqu'un qui part de zéro pour une installation Docker sur un serveur Ubuntu distant. Vous pouvez passer directement à n'importe quelle étape qui vous est utile. Il existe probablement des moyens plus efficaces/évolutifs, mais ce guide fonctionne très bien pour mon cas d'utilisation personnel.
...
- **[Partie I : Partir de zéro](#part-i-starting-from-zero)**
  - [1. Inscription sur DigitalOcean](#1-get-started-on-digitalocean)
...
- **[Partie II : Installation de Docker et autres dépendances](/docs/remote/docker_linux)**

## Partie I : Partir de zéro : [#part-i-starting-from-zero]

### **1. Démarrer sur DigitalOcean** [#1-get-started-on-digitalocean]

[Cliquez ici](https://www.digitalocean.com/?refcode=4486923fcf00&utm_campaign=Referral_Invite&utm_medium=Referral_Program&utm_source=badge) ou sur la bannière ci-dessus pour commencer.
