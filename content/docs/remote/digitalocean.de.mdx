...
Digital Ocean ist eine großartige Option für das Deployment: Sie können von einem **kostenlosen [200 USD Guthaben](https://m.do.co/c/4486923fcf00)** (für 60 Tage) profitieren, und eine der günstigsten Stufen (6 USD/Monat) reicht für LibreChat in einer Umgebung mit geringer Auslastung und wenigen Benutzern aus. Sollten Ihre Ressourcenanforderungen steigen, können Sie jederzeit sehr einfach ein Upgrade durchführen.
...
- **[Teil I: Von Null anfangen](#part-i-starting-from-zero)**
  - [1. DigitalOcean Registrierung](#1-click-here-or-on-the-banner-above-to-get-started-on-digitalocean)
...
- **[Teil II: Installation von Docker & anderen Abhängigkeiten](#part-ii-installing-docker-and-other-dependencies)**

## Teil I: Von Null anfangen: [#part-i-starting-from-zero]

### **1. Erste Schritte auf DigitalOcean** [#1-get-started-on-digitalocean]

[Klicken Sie hier](https://m.do.co/c/4486923fcf00) oder auf das Banner oben, um zu beginnen.
