...
Go to the [LibreChat repository](https://github.com/LibreChat-AI/LibreChat) on GitHub.
...
That's it! You have successfully deployed LibreChat on Railway using the one-click install process. Open that URL, register an account, and follow [Your First Chat](/docs/quick_start/first_chat) to add a model API key and send your first message.
