...
Digital Ocean 是部署的一个绝佳选择：您可以享受 **[200 美元额度](https://m.do.co/c/4486923fcf00)** 的免费赠送（有效期 60 天），并且最低配置方案（6 美元/月）即可在低负载、用户量较少的环境下运行 LibreChat。如果您的资源需求增加，您可以随时轻松升级。
...
- **[第一部分：从零开始](#part-i-starting-from-zero)**
  - [1. DigitalOcean 注册](#1-click-here-or-on-the-banner-above-to-get-started-on-digitalocean)
...
- **[第二部分：安装 Docker 及其他依赖项](#part-ii-installing-docker-and-other-dependencies)**

## 第一部分：从零开始： [#part-i-starting-from-zero]

### **1. 在 DigitalOcean 上开始** [#1-get-started-on-digitalocean]

[点击此处](https://m.do.co/c/4486923fcf00)或点击上方的横幅即可开始。
