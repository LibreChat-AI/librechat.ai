...
> Estas instrucciones + la [guía de Docker](/docs/remote/docker_linux) están diseñadas para alguien que comienza desde cero para una instalación de Docker en un servidor Ubuntu remoto. Puedes saltar a cualquier punto que te sea útil. Probablemente existan formas más eficientes/escalables, pero esta guía funciona muy bien para mi caso de uso personal.
...
- **[Parte I: Empezando desde cero](#part-i-starting-from-zero)**
  - [1. Registro en DigitalOcean](#1-get-started-on-digitalocean)
...
- **[Parte II: Instalación de Docker y otras dependencias](/docs/remote/docker_linux)**

## Parte I: Empezando desde cero: [#part-i-starting-from-zero]

### **1. Comienza en DigitalOcean** [#1-get-started-on-digitalocean]

[Haz clic aquí](https://www.digitalocean.com/?refcode=4486923fcf00&utm_campaign=Referral_Invite&utm_medium=Referral_Program&utm_source=badge) o en el banner de arriba para comenzar.
