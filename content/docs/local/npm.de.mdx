...
- npm `v11.16.0`
  - LibreChat verwendet CommonJS (CJS) und openid-client v6; Node 24 erfüllt die erforderliche Unterstützung für CJS/ESM-Interop, WebCrypto und die Fetch API-Laufzeitumgebung.
