...
Register the first account -- it becomes the admin account -- then follow [Your First Chat](/docs/quick_start/first_chat) to add a model API key and send your first message.
