...
Registre uma conta e, em seguida, siga [Seu Primeiro Chat](/docs/quick_start/first_chat) para adicionar uma chave de API de modelo e enviar sua primeira mensagem.
