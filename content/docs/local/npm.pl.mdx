...
Zarejestruj konto, a następnie postępuj zgodnie z [Twój pierwszy czat](/docs/quick_start/first_chat), aby dodać klucz API modelu i wysłać swoją pierwszą wiadomość.
