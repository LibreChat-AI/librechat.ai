...
- npm `v11.16.0`
  - LibreChat utilise CommonJS (CJS) et openid-client v6 ; Node 24 prend en charge l'interopérabilité CJS/ESM, WebCrypto et l'API Fetch requises au moment de l'exécution.
...
<Callout title="Mettre à jour MONGO_URI" emoji="❗">
