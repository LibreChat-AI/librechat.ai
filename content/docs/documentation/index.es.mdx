...
**Nota: En el siguiente ejemplo:**
  - Proporcioné capturas de pantalla tanto para el modo claro como para el modo oscuro.
  - Utilicé `Image from 'next/image'`, lo que me dio una mejora de 4x en el tamaño del archivo de imagen para un mejor rendimiento.
