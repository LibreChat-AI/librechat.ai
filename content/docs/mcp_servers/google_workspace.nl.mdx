...
- Een draaiende LibreChat-instantie met `librechat.yaml` gekoppeld of anderszins geladen.
...
<Callout type="info" title="Strikte MCP-domein-allowlists">
...
Herstart LibreChat zodat deze `.env` en `librechat.yaml` opnieuw laadt.
