...
<OptionTable
  options={[
    ['BAN_VIOLATIONS', 'boolean', '違反によるユーザーの禁止を有効にするかどうか（禁止されたユーザーもログには記録されます）。','BAN_VIOLATIONS=true'],
...
<OptionTable
  options={[    
    ...
    ['IMPORT_USER_WINDOW', 'integer', '`IMPORT_USER_MAX` インポートの期間を分単位で指定します。','IMPORT_USER_WINDOW=1'],
  ]}
/>
