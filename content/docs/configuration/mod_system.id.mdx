...
Berikut adalah semua variabel env terkait untuk menggunakan dan mengonfigurasi sistem mod. Perhatikan bahwa ini juga terdapat dalam file [/.env.example](https://github.com/LibreChat-AI/LibreChat/blob/main/.env.example), untuk diatur di dalam file `.env` Anda sendiri.
