...
<OptionTable
  options={[
    ...
    ['VIOLATION_SCORE_TTL', 'integer', 'Berapa lama skor pelanggaran bertahan tanpa adanya pelanggaran baru (dalam milidetik). Setiap pelanggaran baru akan memulai ulang hitung mundur, sehingga skor akan meluruh setelah periode tenang alih-alih terakumulasi selamanya. Atur ke 0 agar skor tidak pernah kedaluwarsa (perilaku lama).','VIOLATION_SCORE_TTL=1000 * 60 * 60'],
  ]}
/>
