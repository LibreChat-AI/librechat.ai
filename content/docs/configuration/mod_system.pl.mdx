...
<OptionTable
  options={[
    ...
    ['VIOLATION_SCORE_TTL', 'integer', 'Jak długo wynik naruszenia pozostaje aktywny bez nowych naruszeń (w milisekundach). Każde nowe naruszenie restartuje odliczanie, więc wyniki wygasają po okresie braku aktywności zamiast kumulować się w nieskończoność. Ustaw na 0, aby wyniki nigdy nie wygasały (zachowanie starszych wersji).','VIOLATION_SCORE_TTL=1000 * 60 * 60'],
  ]}
/>
