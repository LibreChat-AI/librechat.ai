...
3. Der Benutzer durchsucht und wählt Dateien über die vertraute SharePoint-Oberfläche aus; aktuelle Auswahlen bleiben markiert, während andere Ordner geöffnet oder die Ansicht der Auswahl gewechselt wird.
...
- **Persistente Auswahl**: Erstellen Sie eine Auswahl über mehrere Ordner und Auswahlansichten hinweg
