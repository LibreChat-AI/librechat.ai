...
<OptionTable
  options={[
    ...
    ['VIOLATION_SCORE_TTL', 'integer', 'Yeni bir ihlal gerçekleşmediğinde ihlal puanının ne kadar süre geçerli kalacağı (milisaniye cinsinden). Her yeni ihlal geri sayımı sıfırlar, böylece puanlar sonsuza kadar birikmek yerine sessiz bir dönemin ardından azalır. Puanların süresinin asla dolmaması için 0 olarak ayarlayın (eski davranış).','VIOLATION_SCORE_TTL=1000 * 60 * 60'],
  ]}
/>
