...
Aşağıdakiler, mod sistemini kullanmak ve yapılandırmak için ilgili tüm .env değişkenleridir. Bunun aynı zamanda kendi `.env` dosyanızda ayarlanmak üzere [/.env.example](https://github.com/LibreChat-AI/LibreChat/blob/main/.env.example) dosyasında da bulunduğunu unutmayın.
