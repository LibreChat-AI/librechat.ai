...
<OptionTable
  options={[    
    ['LIMIT_FORK_IP', 'boolean', 'Ob die Anzahl der Konversations-Forks, die eine IP-Adresse pro `FORK_IP_WINDOW` erstellen kann, begrenzt werden soll.','LIMIT_FORK_IP=true'],
