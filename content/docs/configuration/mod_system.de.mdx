...
<OptionTable
  options={[    
    ['LIMIT_FORK_IP', 'boolean', 'Ob die Anzahl der Konversations-Forks begrenzt werden soll, die eine IP-Adresse pro `FORK_IP_WINDOW` erstellen kann.','LIMIT_FORK_IP=true'],
...
<OptionTable
  options={[    
    ...
    ['OPENAI_MODERATION_API_KEY', 'string', 'Ihr OpenAI API-Key.','OPENAI_MODERATION_API_KEY='],
  ]}
/>
