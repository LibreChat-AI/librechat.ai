...
<OptionTable
  options={[    
    ...
    ['IMPORT_VIOLATION_SCORE', 'integer', 'Punktzahl für Verstöße beim Import von Konversationen.','IMPORT_VIOLATION_SCORE=1'],
...
> Hinweis: Sie können beide Begrenzungen nutzen, standardmäßig erfolgt die Begrenzung jedoch nur nach IP.
