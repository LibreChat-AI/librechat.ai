...
Die folgenden Umgebungsvariablen sind alle relevanten Variablen, um das Mod-System zu nutzen und zu konfigurieren. Beachten Sie, dass diese auch in der Datei [/.env.example](https://github.com/LibreChat-AI/LibreChat/blob/main/.env.example) zu finden sind und in Ihrer eigenen `.env` Datei gesetzt werden müssen.
