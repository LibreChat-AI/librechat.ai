...
<OptionTable
  options={[
    ...
    ['VIOLATION_SCORE_TTL', 'integer', 'Wie lange ein Verstoß-Score ohne neue Verstöße bestehen bleibt (in Millisekunden). Jeder neue Verstoß startet den Countdown neu, sodass Scores nach einer Ruhephase abklingen, anstatt sich für immer anzusammeln. Auf 0 setzen, damit Scores nie ablaufen (Legacy-Verhalten).','VIOLATION_SCORE_TTL=1000 * 60 * 60'],
  ]}
/>
