...
<OptionTable
  options={[    
    ['OPENAI_MODERATION_REVERSE_PROXY', 'string', 'Hinweis: Standardmäßig auskommentiert, funktioniert dies nicht mit allen Reverse Proxys.','# OPENAI_MODERATION_REVERSE_PROXY='],
  ]}
/>
