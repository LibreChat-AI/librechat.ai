...
<OptionTable
  options={[    
    ...
    ['CONCURRENT_VIOLATION_SCORE', 'integer', '并发违规得分。','CONCURRENT_VIOLATION_SCORE=1'],
    ...
    ['CONVO_ACCESS_VIOLATION_SCORE', 'integer', '对话访问违规的评分。','CONVO_ACCESS_VIOLATION_SCORE=0'],
  ]}
/>
...
<OptionTable
  options={[    
    ['LIMIT_MESSAGE_IP', 'boolean', '是否限制一个 IP 在 `MESSAGE_IP_WINDOW` 内可以发送的消息数量。','LIMIT_MESSAGE_IP=true'],
