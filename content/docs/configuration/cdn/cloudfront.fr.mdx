...
<OptionTable
  options={[
    ...
    [
      'imageSigning',
      'string',
      'Mode d\'accès aux médias en ligne. Utilisez `"none"` pour un accès public via CloudFront ou `"cookies"` pour des cookies signés. `"url"` est réservé et n\'est pas implémenté pour les images.',
      'imageSigning: "cookies"',
    ],
    [
      'cookieDomain',
      'string',
      'Domaine parent partagé pour les cookies signés. Requis lorsque `imageSigning` est défini sur `"cookies"`.',
      'cookieDomain: ".example.com"',
    ],
    [
      'cookieExpiry',
    ...
    [
      'storageRegion',
      'string',
      'Étiquette de région facultative pour les chemins d\'objets sensibles à la région.',
      'storageRegion: "us-east-2"',
    ],
    [
      'includeRegionInPath',
