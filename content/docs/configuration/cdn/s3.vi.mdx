...
- **S3_URL_EXPIRY_SECONDS:** (Tùy chọn) Thời hạn của mỗi presigned URL, tính bằng giây. Xem ghi chú về presigned URL bên dưới để biết các giới hạn phía nhà cung cấp được áp dụng.
- **S3_REFRESH_EXPIRY_MS:** (Tùy chọn) Tạo lại một presigned URL khi nó đạt đến độ tuổi này, tính bằng mili giây, thay vì sử dụng logic bộ đệm hết hạn mặc định. Mặc định là không thiết lập. Một giá trị không phải là số nguyên dương sẽ bị bỏ qua kèm theo cảnh báo trong nhật ký (logs).
