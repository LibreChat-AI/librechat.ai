...
Logic làm mới trong LibreChat không được áp dụng nhất quán cho mọi giao diện hiển thị. Ví dụ, các endpoint dạng danh sách có thể trả về các URL đã lưu trữ trong khi các endpoint chi tiết lại làm mới chúng. Điều này có thể gây ra lỗi hiển thị ảnh đại diện bị hỏng trong bộ chọn model và giao diện trò chuyện. Xem [thảo luận liên quan](https://github.com/LibreChat-AI/LibreChat/discussions/10280#discussioncomment-14803903) để biết ngữ cảnh đầy đủ.
