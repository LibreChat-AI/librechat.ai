...
<OptionTable
  options={[
    ['BAN_VIOLATIONS', 'boolean', 'Of het verbannen van gebruikers wegens overtredingen moet worden ingeschakeld (ze worden nog steeds gelogd).','BAN_VIOLATIONS=true'],
...
<OptionTable
  options={[    
    ...
    ['TTS_VIOLATION_SCORE', 'integer', 'Score voor text-to-speech-schendingen.','TTS_VIOLATION_SCORE=0'],
    ['STT_VIOLATION_SCORE', 'integer', 'Score voor speech-to-text-schendingen.','STT_VIOLATION_SCORE=0'],
...
<OptionTable
  options={[    
    ['LIMIT_IMPORT_IP', 'boolean', 'Of het aantal conversatie-imports dat een IP mag uitvoeren per `IMPORT_IP_WINDOW` moet worden beperkt.','LIMIT_IMPORT_IP=true'],
    ...
    ['IMPORT_IP_WINDOW', 'integer', 'Bepaalt in minuten het tijdsbestek voor `IMPORT_IP_MAX` imports.','IMPORT_IP_WINDOW=1'],
  ]}
/>
...
<OptionTable
  options={[    
    ...
    ['IMPORT_USER_MAX', 'integer', 'Het maximale aantal gespreksimportaties dat een gebruiker kan uitvoeren per `IMPORT_USER_WINDOW`.','IMPORT_USER_MAX=50'],
...
<OptionTable
  options={[    
    ['LIMIT_FORK_IP', 'boolean', 'Of het aantal conversatie-forks dat een IP mag aanmaken per `FORK_IP_WINDOW` moet worden beperkt.','LIMIT_FORK_IP=true'],
    ['FORK_IP_MAX', 'integer', 'Het maximale aantal gespreks-forks dat een IP kan aanmaken per `FORK_IP_WINDOW`.','FORK_IP_MAX=30'],
    ['FORK_IP_WINDOW', 'integer', 'Bepaalt in minuten het tijdsvenster voor `FORK_IP_MAX` forks.','FORK_IP_WINDOW=1'],
  ]}
/>
...
<OptionTable
  options={[    
    ...
    ['OPENAI_MODERATION_API_KEY', 'string', 'Uw OpenAI API-sleutel.','OPENAI_MODERATION_API_KEY='],
  ]}
/>
