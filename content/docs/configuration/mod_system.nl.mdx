...
<OptionTable
  options={[
    ...
    ['VIOLATION_SCORE_TTL', 'integer', 'Hoe lang een overtredingsscore blijft bestaan zonder nieuwe overtredingen (in milliseconden). Elke nieuwe overtreding herstart het aftellen, zodat scores na een rustige periode vervallen in plaats van voor altijd op te stapelen. Stel in op 0 om scores nooit te laten verlopen (verouderd gedrag).','VIOLATION_SCORE_TTL=1000 * 60 * 60'],
  ]}
/>
