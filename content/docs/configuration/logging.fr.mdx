...
<OptionTable
  options={[
    [
      'DEBUG_CONSOLE',
      'boolean',
      'Activer les journaux détaillés de la console/stdout dans le même format que les journaux de débogage des fichiers.',
      'DEBUG_CONSOLE=false',
    ],
  ]}
/>
...
<OptionTable
  options={[
    [
      ...
      'number',
      'Configurez la taille de troncature pour les valeurs de chaîne dans les journaux de la console/stdout au format JSON. Par défaut : 255.',
