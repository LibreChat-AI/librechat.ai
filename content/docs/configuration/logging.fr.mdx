...
Les journaux de débogage sont essentiels au travail des développeurs et à la résolution de problèmes. Si vous rencontrez des difficultés lors de l'exécution de LibreChat, reproduisez-les aussi fidèlement que possible et **[signalez le problème](https://github.com/LibreChat-AI/LibreChat/issues)** en joignant vos journaux situés dans `./api/logs/debug-%DATE%.log`.
