...
### 下载 MongoDB Community Server [#download-mongodb-community-server]
...
### 安装 MongoDB Community Server [#install-mongodb-community-server]
...
### 创建数据目录 [#create-a-data-directory]
...
### 启动 MongoDB 服务器 [#start-the-mongodb-server]
...
### 配置 MongoDB 以实现远程访问（可选） [#configure-mongodb-for-remote-access-optional]
