...
## Step 1: 管理者ユーザーの作成 [#step-1-creating-an-admin-user]
...
## Step 2: 認証の有効化と `readWrite` アクセス権を持つユーザーの作成 [#step-2-enabling-authentication-and-creating-a-user-with-readwrite-access]
...
## ステップ 3: `MONGO_URI` を新しい認証情報で更新する [#step-3-update-the-mongo_uri-to-use-the-new-credentials]
