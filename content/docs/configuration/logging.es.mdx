...
<OptionTable
  options={[
    [
      'DEBUG_CONSOLE',
      'boolean',
      'Habilitar registros detallados en consola/stdout con el mismo formato que los registros de depuración en archivo.',
      'DEBUG_CONSOLE=false',
    ],
  ]}
/>
...
<OptionTable
  options={[
    [
      'CONSOLE_JSON',
      'boolean',
      'Habilitar registros de consola/stdout JSON detallados adecuados para implementaciones en la nube como GCP/AWS.',
      'CONSOLE_JSON=false',
    ],
  ]}
/>
