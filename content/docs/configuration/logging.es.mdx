...
### Seguimiento de OpenTelemetry [#opentelemetry-tracing]
...
<OptionTable
  options={[
    ...
    [
      ...
      'boolean',
      'Habilitar los spans a nivel de comando de Redis. Deshabilitado por defecto para mantener los rastreos del backend en un nivel alto.',
