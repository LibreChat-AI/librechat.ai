...
De instelling is uitgeschakeld wanneer deze niet is ingesteld of op `0` staat, `25` milliseconden wordt aanbevolen en waarden boven `1000` worden begrensd. Batching kan tot één geconfigureerd venster aan afleveringslatentie toevoegen.

<Callout type="warning" title="Veiligheid bij rolling deployment">
  Schakel coalescing pas in nadat elke LibreChat-replica batch-frames ondersteunt. Oudere abonnees laten gecombineerde frames vallen.
</Callout>
