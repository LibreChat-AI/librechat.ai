...
3. El usuario explora y selecciona archivos utilizando la interfaz familiar de SharePoint; las selecciones actuales permanecen marcadas mientras se abren otras carpetas o se cambian las vistas del selector.
...
- **Selección persistente**: Cree una selección única a través de múltiples carpetas y vistas de selector
