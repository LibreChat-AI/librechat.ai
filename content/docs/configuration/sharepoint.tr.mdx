...
3. Kullanıcı, tanıdık SharePoint arayüzünü kullanarak dosyalara göz atar ve seçim yapar; diğer klasörleri açarken veya seçici görünümleri arasında geçiş yaparken mevcut seçimler işaretli kalır
...
- **Kalıcı seçim**: Birden fazla klasör ve seçici görünümü genelinde tek bir seçim oluşturun
