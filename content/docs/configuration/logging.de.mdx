...
description: >-
  ...
  diese Logs nutzen, um Probleme zu beheben, Ihren Server zu überwachen und
  Fehler zu melden. Sie können Debug-Logs auch deaktivieren, wenn Sie
...
<OptionTable
  options={[['DEBUG_LOGGING', 'boolean', 'Debug-Logs aktiviert lassen.', 'DEBUG_LOGGING=true']]}
/>
...
<OptionTable
  options={[
    ...
    ['OTEL_LOG_LEVEL', 'string', 'OpenTelemetry SDK Protokoll-Level.', '# OTEL_LOG_LEVEL=INFO'],
    [
      'OTEL_SDK_DISABLED',
      'boolean',
