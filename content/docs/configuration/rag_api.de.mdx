...
Bei der standardmäßigen Docker-Einrichtung wird die `.env`-Datei zwischen LibreChat und der RAG API geteilt. Definieren Sie die RAG-Variablen in derselben Datei. Die vollständige Liste finden Sie in der [RAG API README](https://github.com/LibreChat-AI/rag_api/blob/main/README.md).
</Callout>
...
Eine Einrichtung ohne Container erfordert mehr manuelle Arbeit. Befolgen Sie die Anweisungen im [RAG API repo](https://github.com/LibreChat-AI/rag_api/).
...
Für die vollständige Liste der Variablen und deren Beschreibungen siehe das [RAG API repo](https://github.com/LibreChat-AI/rag_api/).
