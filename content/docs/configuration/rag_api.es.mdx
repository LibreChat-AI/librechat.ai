...
Con la configuración predeterminada de Docker, el archivo `.env` se comparte entre LibreChat y la RAG API. Define las variables de RAG en ese mismo archivo. La lista completa se encuentra en el [RAG API README](https://github.com/LibreChat-AI/rag_api/blob/main/README.md).
</Callout>
...
Una configuración sin contenedores requiere más intervención manual. Sigue las instrucciones en el [RAG API repo](https://github.com/LibreChat-AI/rag_api/).
...
Para obtener la lista completa de variables y sus descripciones, consulta el [repositorio de la RAG API](https://github.com/LibreChat-AI/rag_api/).
