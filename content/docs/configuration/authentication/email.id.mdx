...
Jika Anda ingin menggunakan salah satu layanan yang telah ditentukan sebelumnya, konfigurasikan variabel-variabel ini saja:
Untuk informasi lebih lanjut mengenai layanan email yang didukung: https://nodemailer.com/smtp/well-known-services
