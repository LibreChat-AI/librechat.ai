...
Se você quiser usar um dos serviços predefinidos, configure apenas estas variáveis:
Para mais informações sobre serviços de e-mail suportados: https://nodemailer.com/smtp/well-known-services
