...
<div style={{ padding: "20px", display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
  <div className="image-light-theme">
    <img src="https://github.com/danny-avila/LibreChat/assets/32828263/786fa525-73c4-4640-b4cf-91925ad8802e" style={{ width: "75%", height: "75%" }} alt="Bild für das helle Design" />
  </div>

  <div className="image-dark-theme">
    <img src="https://github.com/danny-avila/LibreChat/assets/32828263/dddc34c6-9602-4177-89e8-4c0db01b0eac" style={{ width: "75%", height: "75%" }} alt="Bild für das dunkle Design" />
  </div>
</div>
...
- [Wiederverwendung von OpenID-Tokens für die Anmeldesitzung](/docs/configuration/authentication/OAuth2-OIDC/token-reuse)
...
6. **Stellen Sie sicher, dass _nonce_ generiert wird**: Einige Identitätsanbieter generieren den `nonce` URL-Parameter, falls dieser in der Anfrage fehlt. Setzen Sie `OPENID_GENERATE_NONCE=true`, um den openid-client dazu zu zwingen, diesen zu generieren.
