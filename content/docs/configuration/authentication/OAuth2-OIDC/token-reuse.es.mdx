...
Para obtener una configuración detallada de Auth0, consulte: [Auth0 OpenID Connect Configuration](/docs/configuration/authentication/OAuth2-OIDC/auth0)
...
8. Limpie la caché de LibreChat y reinicie el servicio.
