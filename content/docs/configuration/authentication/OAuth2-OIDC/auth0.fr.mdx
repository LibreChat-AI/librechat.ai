...
title: Auth0
icon: Auth0
description: Configurer Auth0 comme fournisseur OpenID Connect pour LibreChat
---
...
Auth0 n'autorise pas les URLs `http://localhost` dans les applications en production. Pour le développement/test local, vous devrez utiliser HTTPS. Vous pouvez utiliser des services tels que :
...
- Auth0 renvoie des **jetons d'accès opaques** (format JWE) par défaut
