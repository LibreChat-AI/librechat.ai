...
4. Ingrese una **Description** para su App ID (p. ej., `LibreChat App ID`).
...
4. Ingrese un **Identifier** (por ejemplo, `com.yourdomain.librechat.services`).
...
*Figura 5: Creación del Services ID*
...
*Figura 8: Guardar configuración de ID de servicios de edición*
...
Después de actualizar el archivo `.env`, reinicie LibreChat para aplicar los cambios.
