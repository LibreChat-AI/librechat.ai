...
<Callout type="warning" title="Exclusion mutuelle d'OpenID et SAML">
...
Pour plus de détails, consultez la [documentation node-saml](https://github.com/node-saml/node-saml/tree/master?tab=readme-ov-file#configuration-option-idpcert).
