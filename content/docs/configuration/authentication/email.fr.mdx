...
icon: Mail
description: >-
  Ce guide explique comment configurer la vérification sécurisée par e-mail et
...
<OptionTable
  options={[
    ...
    ['EMAIL_FROM_NAME', 'string', 'Nom de l\'expéditeur (par défaut APP_TITLE si non défini).','EMAIL_FROM_NAME=LibreChat'],
  ]}
/>
...
2. Dans les **[paramètres de compte Google](https://myaccount.google.com/)**, cliquez sur l'onglet « Sécurité » et ouvrez la « Validation en deux étapes ».
