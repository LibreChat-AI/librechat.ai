...
icon: Users
description: >-
  Erfahren Sie, wie Sie LibreChat für die Benutzerauthentifizierung mit LDAP
  konfigurieren.
---
...
<OptionTable
    options={[
        [
            'LDAP_STARTTLS',
            'string',
            'Aktivieren Sie LDAP StartTLS, um die Verbindung auf TLS zu aktualisieren. Setzen Sie dies auf true, um diese Funktion zu aktivieren.',
            'LDAP_STARTTLS=true',
        ],
    ]}
/>
