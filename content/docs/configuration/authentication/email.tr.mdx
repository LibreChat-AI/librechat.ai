...
Önceden tanımlanmış servislerden birini kullanmak istiyorsanız, yalnızca şu değişkenleri yapılandırın:
Desteklenen e-posta servisleri hakkında daha fazla bilgi için: https://community.nodemailer.com/2-0-0-beta/setup-smtp/well-known-services/
