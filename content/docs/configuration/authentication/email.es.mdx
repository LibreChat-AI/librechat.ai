...
<OptionTable
  options={[
    ...
    ['EMAIL_FROM_NAME', 'string', 'Nombre del remitente (usa APP_TITLE por defecto si no se establece).','EMAIL_FROM_NAME=LibreChat'],
  ]}
/>
...
Para más información sobre los servicios de correo electrónico compatibles: https://community.nodemailer.com/2-0-0-beta/setup-smtp/well-known-services/
...
**¡Si no configura correctamente Mailgun o SMTP, LibreChat utilizará el restablecimiento de contraseña no seguro! ¡Esto permite que cualquier persona restablezca cualquier contraseña en su servidor de inmediato, sin que se envíe ningún correo electrónico!**
</Callout>
...
1. Regístrese para obtener una cuenta de Mailgun en [mailgun.com](https://www.mailgun.com/)
...
<OptionTable
  options={[    
    ...
    ['EMAIL_FROM_NAME', 'string', 'Nombre que aparecerá en el campo "de"','EMAIL_FROM_NAME=LibreChat'],
  ]}
/>
