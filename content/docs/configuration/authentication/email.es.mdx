...
<OptionTable
  options={[
    ...
    ['MAILGUN_HOST', 'string', 'Host de API de Mailgun personalizado (opcional). Utilice https://api.eu.mailgun.net para la región de la UE.','MAILGUN_HOST=https://api.mailgun.net'],
  ]}
/>
