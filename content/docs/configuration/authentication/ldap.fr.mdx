...
Cela peut parfois poser problème avec LDAP et vous pourriez souhaiter utiliser un nom d'utilisateur à la place.
...
<OptionTable
  options={[
    [
      ...
      'string',
      'Utiliser le nom d\'utilisateur au lieu de l\'e-mail.',
...
`LDAP_TLS_REJECT_UNAUTHORIZED` est facultatif ; s'il n'est pas spécifié, LibreChat rejettera les connexions TLS/SSL si le certificat du serveur LDAP ne peut pas être vérifié.
