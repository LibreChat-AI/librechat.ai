...
Com a configuração padrão do Docker, o arquivo `.env` é compartilhado entre o LibreChat e a RAG API. Defina as variáveis de RAG nesse mesmo arquivo. A lista completa encontra-se no [RAG API README](https://github.com/LibreChat-AI/rag-api/blob/main/README.md).
</Callout>
...
Uma configuração sem contêiner é mais prática. Siga as instruções no [repositório da RAG API](https://github.com/LibreChat-AI/rag-api/).
...
Para a lista completa de variáveis e suas descrições, veja o [RAG API repo](https://github.com/LibreChat-AI/rag-api/).
