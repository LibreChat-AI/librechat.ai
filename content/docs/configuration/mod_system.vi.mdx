...
Dưới đây là tất cả các biến môi trường liên quan để sử dụng và cấu hình hệ thống mod. Lưu ý rằng thông tin này cũng có trong tệp [/.env.example](https://github.com/LibreChat-AI/LibreChat/blob/main/.env.example), cần được thiết lập trong tệp `.env` của riêng bạn.
