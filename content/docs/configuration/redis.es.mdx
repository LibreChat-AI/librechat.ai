...
El ajuste está desactivado cuando no se establece o se configura en `0`, se recomiendan `25` milisegundos y los valores superiores a `1000` se limitan. El procesamiento por lotes puede añadir hasta una ventana configurada de latencia de entrega.

<Callout type="warning" title="Seguridad de despliegue continuo">
  Habilite la coalescencia solo después de que cada réplica de LibreChat admita marcos por lotes. Los suscriptores más antiguos descartan los marcos coalescentes.
</Callout>
