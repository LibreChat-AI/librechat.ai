...
3. L'utente sfoglia e seleziona i file utilizzando la familiare interfaccia di SharePoint; le selezioni correnti rimangono spuntate durante l'apertura di altre cartelle o il cambio di visualizzazione del selettore.
...
- **Selezione persistente**: Crea un'unica selezione attraverso più cartelle e viste di selezione
