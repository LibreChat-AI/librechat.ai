...
3. 사용자는 익숙한 SharePoint 인터페이스를 사용하여 파일을 탐색하고 선택합니다. 다른 폴더를 열거나 선택기 뷰를 전환하는 동안에도 현재 선택 항목은 체크된 상태로 유지됩니다.
...
- **지속적 선택(Persistent selection)**: 여러 폴더와 선택기 뷰에 걸쳐 하나의 선택 항목을 구성합니다.
