...
### Étape 1 : Configurer les autorisations API [#step-1-configure-api-permissions]
...
3. L'utilisateur parcourt et sélectionne des fichiers en utilisant l'interface familière de SharePoint ; les sélections actuelles restent cochées lors de l'ouverture d'autres dossiers ou du changement de vue du sélecteur.
...
- **Sélection persistante** : Créez une sélection unique à travers plusieurs dossiers et vues de sélecteur
