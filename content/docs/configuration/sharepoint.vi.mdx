...
3. Người dùng duyệt và chọn tệp bằng giao diện SharePoint quen thuộc; các lựa chọn hiện tại vẫn được giữ nguyên trạng thái đã chọn trong khi mở các thư mục khác hoặc chuyển đổi chế độ xem trình chọn.
...
- **Lựa chọn bền vững**: Xây dựng một lựa chọn trên nhiều thư mục và chế độ xem bộ chọn
