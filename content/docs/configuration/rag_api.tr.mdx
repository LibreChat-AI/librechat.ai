...
Varsayılan Docker kurulumuyla, `.env` dosyası LibreChat ve RAG API arasında paylaşılır. RAG değişkenlerini aynı dosya içerisinde tanımlayın. Listenin tamamı [RAG API README](https://github.com/LibreChat-AI/rag_api/blob/main/README.md) dosyasında yer almaktadır.
</Callout>
...
Konteyner dışı bir kurulum daha fazla manuel işlem gerektirir. [RAG API repo](https://github.com/LibreChat-AI/rag_api/) içindeki talimatları izleyin.
...
Değişkenlerin ve açıklamalarının tam listesi için [RAG API repo](https://github.com/LibreChat-AI/rag_api/) sayfasına bakın.
