...
3. De gebruiker bladert en selecteert bestanden via de vertrouwde SharePoint-interface; huidige selecties blijven aangevinkt terwijl andere mappen worden geopend of van weergave in de kiezer wordt gewisseld.
...
- **Persistente selectie**: Bouw één selectie op over meerdere mappen en picker-weergaven
