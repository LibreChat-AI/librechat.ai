...
Pengaturan ini nonaktif jika tidak diatur atau diatur ke `0`, `25` milidetik adalah nilai yang disarankan, dan nilai di atas `1000` akan dibatasi. Batching dapat menambah latensi pengiriman hingga satu jendela yang dikonfigurasi.

<Callout type="warning" title="Keamanan deployment bergulir">
  Aktifkan coalescing hanya setelah setiap replika LibreChat mendukung batch frames. Subscriber versi lama akan membuang frame yang digabungkan (coalesced).
</Callout>
