...
3. Użytkownik przegląda i wybiera pliki za pomocą znanego interfejsu SharePoint; bieżące zaznaczenia pozostają zaznaczone podczas otwierania innych folderów lub przełączania widoków selektora
...
- **Trwały wybór**: Twórz jeden wybór w wielu folderach i widokach selektora
