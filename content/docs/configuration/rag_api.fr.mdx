...
Avec la configuration Docker par défaut, le fichier `.env` est partagé entre LibreChat et l'API RAG. Définissez les variables RAG dans ce même fichier. La liste complète se trouve dans le [RAG API README](https://github.com/LibreChat-AI/rag_api/blob/main/README.md).
</Callout>
...
Une installation sans conteneur demande plus d'implication manuelle. Suivez les instructions dans le [RAG API repo](https://github.com/LibreChat-AI/rag_api/).
...
Pour la liste complète des variables et leurs descriptions, consultez le [dépôt RAG API](https://github.com/LibreChat-AI/rag_api/).
