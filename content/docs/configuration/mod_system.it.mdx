...
Di seguito sono riportate tutte le variabili d'ambiente correlate per utilizzare e configurare il sistema di mod. Nota che queste si trovano anche nel file [/.env.example](https://github.com/LibreChat-AI/LibreChat/blob/main/.env.example), da impostare nel proprio file `.env`.
