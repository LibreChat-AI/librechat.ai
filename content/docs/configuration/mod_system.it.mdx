...
<OptionTable
  options={[
    ...
    ['VIOLATION_SCORE_TTL', 'integer', 'Per quanto tempo un punteggio di violazione rimane attivo senza nuove violazioni (in millisecondi). Ogni nuova violazione riavvia il conto alla rovescia, quindi i punteggi decadono dopo un periodo di inattività invece di accumularsi per sempre. Impostare a 0 per non far scadere mai i punteggi (comportamento legacy).','VIOLATION_SCORE_TTL=1000 * 60 * 60'],
  ]}
/>
