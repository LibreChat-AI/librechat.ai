...
W domyślnej konfiguracji Docker, plik `.env` jest współdzielony między LibreChat a RAG API. Zdefiniuj zmienne RAG w tym samym pliku. Pełna lista znajduje się w [RAG API README](https://github.com/LibreChat-AI/rag_api/blob/main/README.md).
</Callout>
...
Konfiguracja bez użycia kontenerów wymaga więcej pracy ręcznej. Postępuj zgodnie z instrukcjami w [repozytorium RAG API](https://github.com/LibreChat-AI/rag_api/).
...
Pełną listę zmiennych oraz ich opisy można znaleźć w [repozytorium RAG API](https://github.com/LibreChat-AI/rag_api/).
