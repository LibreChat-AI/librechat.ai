...
3. O usuário navega e seleciona arquivos usando a interface familiar do SharePoint; as seleções atuais permanecem marcadas ao abrir outras pastas ou alternar as visualizações do seletor.
...
- **Seleção persistente**: Crie uma seleção única através de múltiplas pastas e visualizações de seletor
