...
Log debug sangat penting untuk pekerjaan pengembang dan perbaikan masalah. Jika Anda mengalami masalah saat menjalankan LibreChat, reproduksi sedekat mungkin, dan **[laporkan masalah tersebut](https://github.com/LibreChat-AI/LibreChat/issues)** dengan menyertakan log Anda yang ditemukan di `./api/logs/debug-%DATE%.log`.
