...
Dengan pengaturan Docker default, file `.env` digunakan bersama antara LibreChat dan RAG API. Definisikan variabel RAG di dalam file yang sama tersebut. Daftar lengkapnya terdapat di [RAG API README](https://github.com/LibreChat-AI/rag-api/blob/main/README.md).
</Callout>
...
Pengaturan non-kontainer lebih bersifat praktis (hands-on). Ikuti petunjuk di [RAG API repo](https://github.com/LibreChat-AI/rag-api/).
...
Untuk daftar lengkap variabel dan deskripsinya, lihat [RAG API repo](https://github.com/LibreChat-AI/rag-api/).
