...
다음은 모드(mod) 시스템을 사용하고 구성하기 위한 모든 관련 env 변수입니다. 이 내용은 [/.env.example](https://github.com/LibreChat-AI/LibreChat/blob/main/.env.example) 파일에서도 확인할 수 있으며, 사용자의 `.env` 파일에 설정해야 합니다.
