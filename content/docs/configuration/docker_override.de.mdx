...
Um das `api`-Image lokal zu erstellen, die Konfigurationsdatei einzubinden und eine ältere MongoDB zu verwenden, die keine AVX-Unterstützung erfordert:
...
- **Rangfolge:** Werte in der Override-Datei haben Vorrang vor denselben Werten in der `docker-compose.yml`.
