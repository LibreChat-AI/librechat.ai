...
- [Verständnis mehrerer Compose-Dateien](https://docs.docker.com/compose/multiple-compose-files/extends/#understanding-multiple-compose-files)
- [Compose-Dateien zusammenführen](https://docs.docker.com/compose/multiple-compose-files/merge/#merge-compose-files)
