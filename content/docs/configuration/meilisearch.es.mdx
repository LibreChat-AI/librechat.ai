...
Si ejecutas LibreChat como un clúster de nodos o una implementación de múltiples nodos, establece `MEILI_NO_SYNC` en `true` para que solo una instancia gestione la indexación. Esto evita la sincronización redundante de documentos de la base de datos entre instancias y el uso innecesario de recursos que esto conlleva.
