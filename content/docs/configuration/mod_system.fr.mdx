...
<OptionTable
  options={[    
    ...
    ['IMPORT_IP_MAX', 'integer', 'Le nombre maximal d\'importations de conversations qu\'une IP peut effectuer par `IMPORT_IP_WINDOW`.','IMPORT_IP_MAX=100'],
...
<OptionTable
  options={[    
    ['LIMIT_FORK_IP', 'boolean', 'Indique s\'il faut limiter le nombre de bifurcations de conversation qu\'une IP peut créer par `FORK_IP_WINDOW`.','LIMIT_FORK_IP=true'],
