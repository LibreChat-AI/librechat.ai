...
<OptionTable
  options={[
    ['BAN_VIOLATIONS', 'boolean', 'Indique s\'il faut autoriser le bannissement des utilisateurs en cas d\'infraction (ils seront toujours enregistrés).','BAN_VIOLATIONS=true'],
