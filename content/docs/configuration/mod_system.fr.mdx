...
En production, vous devriez avoir Cloudflare ou une autre protection DDoS en place pour protéger réellement le serveur contre les requêtes excessives, mais ces changements vous protégeront en grande partie contre un ou plusieurs acteurs malveillants ciblant votre instance déployée pour le proxying.
