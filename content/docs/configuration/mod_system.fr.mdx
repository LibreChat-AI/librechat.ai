...
<OptionTable
  options={[
    ...
    ['VIOLATION_SCORE_TTL', 'integer', 'Durée de vie d\'un score de violation sans nouvelle violation (en millisecondes). Chaque nouvelle violation réinitialise le compte à rebours, de sorte que les scores diminuent après une période d\'inactivité au lieu de s\'accumuler indéfiniment. Définissez sur 0 pour ne jamais faire expirer les scores (comportement hérité).','VIOLATION_SCORE_TTL=1000 * 60 * 60'],
  ]}
/>
