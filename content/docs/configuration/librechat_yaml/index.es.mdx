...
Esto utiliza el patrón [docker-compose.override.yml](/docs/configuration/docker_override): Docker Compose lo combina automáticamente con el `docker-compose.yml` principal, por lo que tus personalizaciones sobreviven a las actualizaciones.
...
Para validar la sintaxis de tu YAML antes de reiniciar, utiliza el [YAML Validator](/toolkit/yaml_checker) o [yamlchecker.com](https://yamlchecker.com/).
...
2. Valida tu sintaxis YAML con el [YAML Validator](/toolkit/yaml_checker)
