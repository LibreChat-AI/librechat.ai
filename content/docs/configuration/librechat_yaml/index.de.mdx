...
### Datei suchen oder erstellen [#locate-or-create-the-file]
...
Dies verwendet das [docker-compose.override.yml](/docs/configuration/docker_override) Muster -- Docker Compose führt es automatisch mit der Haupt-`docker-compose.yml` zusammen, sodass Ihre Anpassungen Updates überstehen.
...
### Server wird beim Start sofort beendet [#server-exits-immediately-on-startup]
