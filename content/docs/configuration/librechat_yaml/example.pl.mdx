...
## Czysty przykład [#clean-example]

<Callout type="example" title="Przykład" collapsible>

Ten przykładowy plik konfiguracyjny zawiera wszystkie udokumentowane endpoint (z wyjątkiem Azure, LiteLLM, MLX oraz Ollama, które wymagają dodatkowych konfiguracji).
...
## Przykład z komentarzami [#example-with-comments]
...
<Callout type="example" title="Skomentowany przykład" collapsible>
