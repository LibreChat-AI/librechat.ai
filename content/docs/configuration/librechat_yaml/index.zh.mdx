...
title: 自定义配置
icon: BookOpen
description: 创建、挂载并配置 librechat.yaml 文件，以实现自定义 AI endpoint 和高级 LibreChat 设置
---
...
有关包含更多 endpoint 示例的完整注释配置文件，请参阅 [示例配置](/docs/configuration/librechat_yaml/example)。
