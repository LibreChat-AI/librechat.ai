...
3. **Supprimer les paramètres hérités** : Si vous utilisez l'une des [configurations héritées](#legacy-setup), supprimez-les. Le serveur LibreChat les détectera également et vous le rappellera.
