...
title: OpenRouter
icon: OpenRouter
description: Konfiguriere OpenRouter als benutzerdefinierten endpoint in LibreChat.
---
...
Damit jeder Benutzer seinen eigenen Schlüssel über die LibreChat UI eingeben kann, anstatt einen aus der `.env` zu lesen, setzen Sie `apiKey: "user_provided"`. Benutzer sehen dann ein Schlüsseleingabefeld, wenn sie den endpoint auswählen.
