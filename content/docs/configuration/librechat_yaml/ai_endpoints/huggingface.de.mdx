...
title: Huggingface
icon: HuggingFace
description: Beispielkonfiguration für Huggingface
---
...
- Die bereitgestellten Modelle sind kostenlos, unterliegen jedoch einer Ratenbegrenzung.

  - Die Verwendung von [`dropParams`](/docs/configuration/librechat_yaml/object_structure/custom_endpoint#dropparams), um "top_p"-Parameter zu entfernen, ist erforderlich.
  - Das Abrufen von Modellen wird nicht unterstützt
  - Hinweis: Einige Modelle funktionieren derzeit besser als andere, die Antworten sind sehr kurz (zumindest bei der Nutzung des kostenlosen Tarifs).

- Das Beispiel enthält eine Modellliste, die zu Ihrer Information zuletzt am 09. Mai 2024 aktualisiert wurde.
