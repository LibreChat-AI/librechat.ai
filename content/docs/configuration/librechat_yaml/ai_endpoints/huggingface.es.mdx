...
title: Hugging Face
icon: HuggingFace
description: Configuración de ejemplo para Huggingface
---

> Token de HuggingFace: [huggingface.co/settings/tokens](https://huggingface.co/settings/tokens)

**Notas:**

- **Conocido:** icono proporcionado.

- Los modelos proporcionados son gratuitos pero tienen límites de tasa.

  - El uso de [`dropParams`](/docs/configuration/librechat_yaml/object_structure/custom_endpoint#dropparams) para eliminar los parámetros "top_p" es obligatorio.
  - La obtención de modelos no es compatible
  - Nota: Algunos modelos funcionan actualmente mejor que otros, las respuestas son muy breves (al menos cuando se utiliza el nivel gratuito).

- El ejemplo incluye una lista de modelos, la cual fue actualizada por última vez el 09 de mayo de 2024, para su conveniencia.
