...
title: Huggingface
icon: HuggingFace
description: Exemple de configuration pour Huggingface
---

> Jeton HuggingFace : [huggingface.co/settings/tokens](https://huggingface.co/settings/tokens)

**Notes :**

- **Connu :** icône fournie.

- Les modèles fournis sont gratuits mais soumis à des limites de débit.

  - L'utilisation de [`dropParams`](/docs/configuration/librechat_yaml/object_structure/custom_endpoint#dropparams) pour supprimer les paramètres "top_p" est requise.
  - La récupération des modèles n'est pas prise en charge
  - Remarque : Certains modèles fonctionnent actuellement mieux que d'autres, les réponses sont très courtes (du moins lors de l'utilisation de l'offre gratuite).

- L'exemple inclut une liste de modèles, qui a été mise à jour pour la dernière fois le 09 mai 2024, pour votre commodité.
