...
- Das Beispiel verbindet sich mit einem lokalen vLLM-Server auf Port 8023 mit Gemma 3 27B als Standard. Setzen Sie `baseURL` auf den Ort, an dem Ihr Server läuft.
