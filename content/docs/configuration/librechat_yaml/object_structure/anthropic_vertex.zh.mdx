...
`models` 字段定义了可用的 Claude 模型，并将用户友好的名称映射到 Vertex AI 部署 ID。其工作方式与 [Azure OpenAI 模型映射](/docs/configuration/librechat_yaml/object_structure/azure_openai#group-object-structure) 类似。
