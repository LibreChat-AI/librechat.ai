...
Yapılandırılmış bir SearXNG, Firecrawl, Jina, Tavily uyumlu veya ilgili sağlayıcı endpoint'i kasten özel (private) olduğunda `webSearch.allowedAddresses` kullanın:
