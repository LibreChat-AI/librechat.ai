...
<OptionTable
  options={[
    [
      'addParams',
      'Object/Dictionary',
      'Adiciona parâmetros adicionais às solicitações. Os valores podem ser strings, números, booleanos, arrays ou objetos aninhados. Suporta `web_search: true` para habilitar a pesquisa na web em solicitações.',
...
**Placeholders de Campos de Usuário Disponíveis:**
