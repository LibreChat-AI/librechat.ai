...
Quando uma Action é criada a partir de metadados OpenAPI, o LibreChat também verifica se o domínio da Action enviado corresponde à URL do servidor da especificação. Se o domínio enviado incluir uma porta explícita, ela deve corresponder à porta efetiva da URL do servidor (`443` para HTTPS ou `80` para HTTP quando a URL omite uma).
