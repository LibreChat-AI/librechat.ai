...
<OptionTable
    options={[
        ['enabled', 'Boolean', 'Controla si se deben guardar los registros de transacciones en la base de datos.', 'Default: true. Set to false to disable transaction recording (unless balance.enabled is true).'],
    ]}
/>
