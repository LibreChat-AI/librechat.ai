...
Khi một Action được tạo từ siêu dữ liệu OpenAPI, LibreChat cũng xác minh rằng miền Action đã gửi khớp với URL máy chủ của spec. Nếu miền đã gửi bao gồm một cổng cụ thể, nó phải khớp với cổng hiệu dụng của URL máy chủ (`443` cho HTTPS hoặc `80` cho HTTP khi URL bỏ qua cổng).
