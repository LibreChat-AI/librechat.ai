...
> **Ważne:** Claude Opus 4.7 i nowsze, Opus 5, Sonnet 5 oraz Fable/Mythos 5 lub 5.1 wymagają `global`, `us` lub `eu`. Określone regiony, takie jak `us-east5`, obsługują Claude Sonnet 4.6 i starsze, a w przypadku nowszych modeli zwracają odpowiedź model-not-found. Użyj `global`, aby uzyskać najszerszą dostępność i uniknąć regionalnych dopłat, lub `us`/`eu`, gdy potrzebujesz rezydencji danych w wielu regionach.
