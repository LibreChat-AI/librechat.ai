...
Gdy Akcja jest tworzona na podstawie metadanych OpenAPI, LibreChat weryfikuje również, czy przesłana domena Akcji jest zgodna z adresem URL serwera określonym w specyfikacji. Jeśli przesłana domena zawiera jawny port, musi on być zgodny z efektywnym portem adresu URL serwera (`443` dla HTTPS lub `80` dla HTTP, gdy adres URL go pomija).
