...
Programmatic Tool Calling ist optional. Fügen Sie `programmatic_tools` neben `execute_code` nur dann hinzu, wenn Ihre Code Interpreter-Bereitstellung die Tool Call Server-Komponente enthält.
