...
<OptionTable
  options={[
    [
      'agent',
      'Object | Union',
      'Konfiguriert den für die Speicherverarbeitung zuständigen Agenten. Kann entweder ein Verweis auf einen bestehenden Agenten per ID oder eine vollständige Agentenkonfiguration sein.',
...
- Die Agent-Konfiguration ermöglicht die Anpassung des Speicherverarbeitungsverhaltens.
