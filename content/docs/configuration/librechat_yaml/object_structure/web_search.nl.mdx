...
Gebruik `webSearch.allowedAddresses` wanneer een geconfigureerde SearXNG, Firecrawl, Jina, Tavily-compatibele, Keenable-compatibele of gerelateerde provider endpoint bewust privé is:
...
<OptionTable
  options={[
    ['searchProvider', 'String', 'Specificeert welke zoekprovider moet worden gebruikt.', 'Options: "serper", "searxng", "tavily", "keenable"'],
  ]}
/>
...
<OptionTable
  options={[
    ['keenableApiKey', 'String', 'Omgevingsvariabele voor de optionele Keenable API-sleutel. Keenable werkt zonder sleutel; het configureren ervan verhoogt de publieke tarieflimieten.', '${KEENABLE_API_KEY}'],
  ]}
/>
...
<OptionTable
  options={[
    ['keenableApiUrl', 'String', 'Omgevingsvariabele voor een aangepaste Keenable search API URL. Dit wijzigt niet het page-fetch endpoint.', '${KEENABLE_API_URL}'],
  ]}
/>

Het page-fetch endpoint wordt afzonderlijk geconfigureerd met de omgevingsvariabele `KEENABLE_FETCH_URL`.

### keenableSearchOptions

<OptionTable
  options={[
    ['keenableSearchOptions', 'Object', 'Configuratieopties voor Keenable search.', ''],
  ]}
/>

<OptionTable
  options={[
    ['maxResults', 'Number', 'Maximum aantal zoekresultaten.', 'Range: 1-20. Default: 8'],
    ['site', 'String', 'Beperkt resultaten tot één domein.', ''],
    ['attributionTitle', 'String', 'Waarde verzonden in de X-Keenable-Title attributie-header.', ''],
    ['timeout', 'Number', 'Client-side HTTP-verzoek-timeout in milliseconden.', 'Range: 0-120000. Default: 15000'],
  ]}
/>
...
<OptionTable
  options={[
    ['scraperProvider', 'String', 'Geeft aan welke scraper-service moet worden gebruikt.', 'Options: "firecrawl", "serper", "tavily", "keenable"'],
  ]}
/>
...
<OptionTable
  options={[
    ['keenableScraperOptions', 'Object', 'Configuratieopties voor het ophalen van pagina\'s via Keenable.', ''],
  ]}
/>
...
Keenable kan zoeken, pagina's ophalen of beide bieden. De publieke endpoints werken zonder sleutel; de optionele `keenableApiKey` verhoogt de rate limits. Stel `rerankerType: "none"` in om te voorkomen dat een reranker-sleutel vereist is:
...
- Keenable ondersteunt keyless search en page fetch; de optionele key verhoogt de openbare rate limits, en de fetch URL override is alleen voor de omgeving.
