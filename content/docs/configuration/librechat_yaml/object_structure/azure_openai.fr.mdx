...
**[Pour un guide détaillé sur la configuration des paramètres Azure OpenAI, cliquez ici](/docs/configuration/librechat_yaml/ai_endpoints/azure)**
...
<OptionTable
  options={[
    ['dropParams', 'Array/List of Strings', 'Supprime les paramètres par défaut des requêtes. Exclut les paramètres par défaut spécifiés.', 'Default parameters are the standard request parameters LibreChat sends to the Azure OpenAI API.'],
  ]}
/>
