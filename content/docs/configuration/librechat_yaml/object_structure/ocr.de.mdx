...
- `azure_mistral_ocr`: Verwendet Mistral OCR-Modelle, die auf [Azure AI Foundry](/docs/features/ocr#2-azure-mistral-ocr) bereitgestellt wurden.
...
- `custom_ocr`: Verwendet einen benutzerdefinierten OCR-Dienst, der durch die `baseURL` angegeben wird [(noch nicht implementiert)](/docs/features/ocr#future-enhancements).
