...
Verwenden Sie `webSearch.allowedAddresses`, wenn ein konfigurierter SearXNG-, Firecrawl-, Jina-, Tavily-kompatibler oder ein verwandter endpoint bewusst privat ist:
