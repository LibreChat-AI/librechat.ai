...
Das Modell kann ein geeignetes Tool starten, weiterarbeiten und mit `check_background_task` abfragen. Abgeschlossene Code-Ausgaben und generierte Dateien werden an den ursprünglichen Code-Aufruf angehängt. Der Status von Hintergrundaufgaben ist prozesslokal und übersteht weder einen Serverneustart noch eine Verschiebung zwischen Replikaten.
