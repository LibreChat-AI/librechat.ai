...
Das `models`-Feld definiert die verfügbaren Claude-Modelle und ordnet benutzerfreundliche Namen den Vertex AI-Deployment-IDs zu. Dies funktioniert ähnlich wie das [Azure OpenAI-Modell-Mapping](/docs/configuration/librechat_yaml/object_structure/azure_openai#group-object-structure).
