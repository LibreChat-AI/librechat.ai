...
<OptionTable
  options={[
    ...
    ['autoTranscribeAudio', 'Boolean', 'Houd de microfoon ingeschakeld in plaats van te stoppen bij de eerste pauze. Met een externe engine schakelt het ook stiltedetectie in op basis van `decibelValue`.', ''],
    ['decibelValue', 'Number', 'Decibel-drempelwaarde voor stiltedetectie. Bereik -100 tot -30, standaard -45.', ''],
    ['autoSendText', 'Number', 'Seconden om te wachten na transcriptie voor automatisch verzenden. `0` verzendt onmiddellijk; `-1` schakelt automatisch verzenden uit.', ''],
  ]}
/>
