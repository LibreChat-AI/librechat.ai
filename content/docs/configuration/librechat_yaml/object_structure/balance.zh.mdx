...
<OptionTable
    options={[
        ['enabled', 'Boolean', '启用用户的令牌额度跟踪和余额管理。', 'Set to true to activate balance tracking for token usage.'],
    ]}
/>
...
<OptionTable
    options={[
        ['refillIntervalValue', 'Integer', '指定自动补充 token 额度的间隔数值。', 'For example, 30 represents a 30-day interval.'],
    ]}
/>
