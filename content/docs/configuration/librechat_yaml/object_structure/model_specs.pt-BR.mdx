...
> **Google / Anthropic** normalmente suportam `topP`, `topK`, `maxOutputTokens`.  
> **Anthropic / Bedrock (modelos Anthropic e Nova)** suportam `promptCache`.  
...
> **Suportado por:** `anthropic`, `bedrock` (modelos Anthropic e Nova)  
> (Alternar o recurso de “prompt-caching” da Anthropic)

<OptionTable
  options={[
    ['promptCache', 'Boolean', 'Ativa ou desativa o cache de prompt integrado da Anthropic.', ''],
  ]}
/>
