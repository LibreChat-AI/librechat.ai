...
Utilizza `webSearch.allowedAddresses` quando un endpoint configurato per SearXNG, Firecrawl, Jina, compatibile con Tavily, compatibile con Keenable o un provider correlato è deliberatamente privato:
...
<OptionTable
  options={[
    ['searchProvider', 'String', 'Specifica quale provider di ricerca utilizzare.', 'Options: "serper", "searxng", "tavily", "keenable"'],
  ]}
/>
...
<OptionTable
  options={[
    ['keenableApiKey', 'String', 'Nome della variabile d\'ambiente per la chiave API opzionale di Keenable. Keenable funziona senza una chiave; configurarne una aumenta i limiti di frequenza pubblici.', '${KEENABLE_API_KEY}'],
  ]}
/>
...
<OptionTable
  options={[
    ['keenableApiUrl', 'String', 'Nome della variabile d\'ambiente per un URL personalizzato dell\'API di ricerca Keenable. Questo non modifica l\'endpoint di recupero della pagina.', '${KEENABLE_API_URL}'],
  ]}
/>

L'endpoint page-fetch viene configurato separatamente con la variabile solo ambiente `KEENABLE_FETCH_URL`.

### keenableSearchOptions

<OptionTable
  options={[
    ['keenableSearchOptions', 'Object', 'Opzioni di configurazione per la ricerca Keenable.', ''],
  ]}
/>

<OptionTable
  options={[
    ['maxResults', 'Number', 'Numero massimo di risultati di ricerca.', 'Range: 1-20. Default: 8'],
    ['site', 'String', 'Limita i risultati a un solo dominio.', ''],
    ['attributionTitle', 'String', 'Valore inviato nell\'intestazione di attribuzione X-Keenable-Title.', ''],
    ['timeout', 'Number', 'Timeout della richiesta HTTP lato client in millisecondi.', 'Range: 0-120000. Default: 15000'],
  ]}
/>
...
<OptionTable
  options={[
    ['scraperProvider', 'String', 'Specifica quale servizio di scraper utilizzare.', 'Options: "firecrawl", "serper", "tavily", "keenable"'],
  ]}
/>
...
<OptionTable
  options={[
    ['keenableScraperOptions', 'Object', 'Opzioni di configurazione per il recupero pagina Keenable.', ''],
  ]}
/>
...
Keenable può fornire ricerca, recupero di pagine o entrambi. I suoi endpoint pubblici funzionano senza una chiave; l'opzione `keenableApiKey` facoltativa aumenta i limiti di frequenza. Imposta `rerankerType: "none"` per evitare di richiedere una chiave per il reranker:
...
- Keenable supporta la ricerca senza chiavi e il recupero delle pagine; la sua chiave opzionale aumenta i limiti di velocità pubblici e il suo override dell'URL di recupero è solo per l'ambiente.
