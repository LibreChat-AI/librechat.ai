...
> **Google / Anthropic** biasanya mendukung `topP`, `topK`, `maxOutputTokens`.  
> **Anthropic / Bedrock (model Anthropic dan Nova)** mendukung `promptCache`.  
...
> **Didukung oleh:** `anthropic`, `bedrock` (model Anthropic dan Nova)  
> (Alihkan fitur “prompt-caching” Anthropic)

<OptionTable
  options={[
    ['promptCache', 'Boolean', 'Mengaktifkan atau menonaktifkan fitur prompt caching bawaan Anthropic.', ''],
  ]}
/>
