...
Il modello può avviare uno strumento idoneo, continuare a lavorare ed eseguire il polling con `check_background_task`. L'output del codice completato e i file generati vengono allegati alla chiamata di codice originale. Lo stato dell'attività in background è locale al processo e non sopravvive a un riavvio del server o allo spostamento tra repliche.
