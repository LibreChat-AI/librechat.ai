...
<OptionTable
  options={[
    [
      'allowedAddresses',
      'Array of Strings',
      'Validated private host:port entries reserved for exempting speech targets from SSRF checks.',
      'allowedAddresses: ["tts.internal:8080"]',
    ],
  ]}
/>
...
<Callout type="warning" title="v0.8.8-rc1 behavior">
  `speech.tts.allowedAddresses` and `speech.stt.allowedAddresses` are validated and preserved by the configuration loader, but speech requests do not consult them yet. They do not authorize private TTS or STT targets in this release candidate.
</Callout>
...
<OptionTable
  options={[
    ['engineSTT', 'String', 'Default STT engine. Options: `"openai"`, `"azureOpenAI"`.', ''],
...
<OptionTable
  options={[
    ['engineTTS', 'String', 'Default TTS engine. Options: `"openai"`, `"azureOpenAI"`, `"elevenlabs"`, `"localai"`.', ''],
