...
Sử dụng `webSearch.allowedAddresses` khi một endpoint của SearXNG, Firecrawl, Jina, tương thích với Tavily hoặc nhà cung cấp liên quan đã được cấu hình là cố ý ở chế độ riêng tư:
