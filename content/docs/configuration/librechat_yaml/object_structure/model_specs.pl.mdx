...
Model może uruchomić odpowiednie narzędzie, kontynuować pracę i odpytywać za pomocą `check_background_task`. Ukończone dane wyjściowe kodu oraz wygenerowane pliki są dołączane do pierwotnego wywołania kodu. Stan zadania w tle jest lokalny dla procesu i nie przetrwa restartu serwera ani przeniesienia między replikami.
