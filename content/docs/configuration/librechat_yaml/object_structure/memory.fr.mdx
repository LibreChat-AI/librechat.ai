...
<OptionTable
  options={[
    [
      'agent',
      'Object | Union',
      'Configure l\'agent responsable du traitement de la mémoire. Peut être soit une référence à un agent existant par ID, soit une configuration d\'agent complète.',
