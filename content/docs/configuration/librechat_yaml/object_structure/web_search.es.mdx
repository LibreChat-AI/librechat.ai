...
Utilice `webSearch.allowedAddresses` cuando un endpoint configurado de SearXNG, Firecrawl, Jina, compatible con Tavily o un proveedor relacionado sea deliberadamente privado:
