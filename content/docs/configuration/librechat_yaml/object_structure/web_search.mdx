...
<OptionTable
  options={[
    ...
    ['maxResults', 'Number', 'The maximum number of search results to return.', 'Range: 0-20. Default: 5'],
...
<OptionTable
  options={[
    ...
    ['chunksPerSource', 'Number', 'Maximum number of relevant content chunks (up to 500 characters each) returned per source. Chunks appear in raw_content as: chunk 1 [...] chunk 2 [...] chunk 3.', 'Range: 1-5. Default: 3'],
    ...
    ['timeout', 'Number', 'Timeout in milliseconds. Controls both the client-side HTTP timeout and the Tavily server-side extraction timeout (converted to seconds, clamped to 1-60s).', 'Default: 15000'],
  ]}
/>
