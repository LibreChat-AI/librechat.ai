...
Le modèle peut démarrer un outil éligible, continuer à travailler et effectuer une interrogation avec `check_background_task`. La sortie de code terminée et les fichiers générés sont joints à l'appel de code original. L'état de la tâche en arrière-plan est local au processus et ne survit pas à un redémarrage du serveur ou à un déplacement entre les répliques.
