...
<OptionTable
  options={[
    [
      'conversation_starters',
      'Array of Strings',
      'Suggested starter prompts shown on the chat landing when this model spec is selected.',
      'No default. Optional.',
    ],
  ]}
/>
...
**Description:**
Conversation starters give users curated first prompts for a model spec. They are shown on the empty chat landing for the selected spec and are especially useful with `showOnLanding` branding.
...
<OptionTable
  options={[
    [
      'conversation_starters',
      'Array of Strings',
      'Suggested prompts shown as clickable cards on the chat landing page while this model spec is active. Clicking a starter submits it as the first message.',
      'No default. Optional.',
    ],
  ]}
/>
...
**Description:**
Suggested prompts shown on the chat landing page while this model spec is active, mirroring the conversation starters available to agents and assistants. Clicking a starter submits it as the first message of a new conversation.
...
**Example:**
```yaml filename="modelSpecs / list / {spec_item} / conversation_starters"
conversation_starters:
