...
La llamada a herramientas programática (Programmatic Tool Calling) es opcional. Añade `programmatic_tools` junto a `execute_code` solo cuando tu despliegue de Code Interpreter incluya el componente Tool Call Server.
