...
<OptionTable
  options={[
    ['stt', 'Object', 'Configurações para processamento de arquivos de áudio Speech-to-Text (STT).', 'Configures which audio file types are processed using STT for transcription.'],
  ]}
/>
