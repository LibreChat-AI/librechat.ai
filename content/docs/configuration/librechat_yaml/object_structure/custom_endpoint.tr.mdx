...
<OptionTable
  options={[
    [
      'addParams',
      'Object/Dictionary',
      'İsteklere ek parametreler ekler. Değerler dizeler, sayılar, boole değerleri, diziler veya iç içe geçmiş nesneler olabilir. İsteklerde web aramasını etkinleştirmek için `web_search: true` desteği sunar.',
