...
| `{{LIBRECHAT_USER_USERNAME}}` | `username` | String | Benutzername |
...
| `{{LIBRECHAT_USER_ROLE}}` | `role` | String | Benutzerrolle (z. B. "user", "admin") |
...
| `{{LIBRECHAT_USER_TERMSACCEPTED}}` | `termsAccepted` | Boolean → String | Status der Nutzungsbedingungen ("true" oder "false") |
