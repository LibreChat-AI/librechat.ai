...
Use `webSearch.allowedAddresses` quando um endpoint configurado de SearXNG, Firecrawl, Jina, compatível com Tavily ou provedor relacionado for deliberadamente privado:
