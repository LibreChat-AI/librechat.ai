...
pollIntervalMs: 2500
```
**Hinweis:** Derzeit wird dies nur von Azure Assistants verwendet. Höhere Werte werden für Azure Assistants empfohlen, um Fehler durch Ratenbegrenzungen zu vermeiden.
