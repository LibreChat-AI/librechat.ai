...
Użyj `webSearch.allowedAddresses`, gdy skonfigurowany endpoint dla SearXNG, Firecrawl, Jina, dostawcy kompatybilnego z Tavily lub pokrewnego jest celowo prywatny:
