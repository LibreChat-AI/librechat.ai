...
Mô hình có thể khởi chạy một công cụ đủ điều kiện, tiếp tục làm việc và thăm dò bằng `check_background_task`. Đầu ra mã đã hoàn thành và các tệp được tạo sẽ được đính kèm vào lệnh gọi mã gốc. Trạng thái tác vụ nền là cục bộ theo tiến trình và sẽ không tồn tại sau khi khởi động lại máy chủ hoặc di chuyển giữa các bản sao.
