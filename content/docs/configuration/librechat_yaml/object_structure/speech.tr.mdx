...
<OptionTable
  options={[
    ...
    ['autoTranscribeAudio', 'Boolean', 'Mikrofonu ilk duraklamada durdurmak yerine dinlemeye devam etmesini sağlar. Harici bir motorla birlikte, `decibelValue` değerine dayalı sessizlik algılamayı da açar.', ''],
    ['decibelValue', 'Number', 'Sessizlik algılama için desibel eşiği. Aralık -100 ile -30 arası, varsayılan -45.', ''],
    ['autoSendText', 'Number', 'Transkripsiyondan sonra otomatik gönderme için beklenecek saniye. `0` anında gönderir; `-1` otomatik göndermeyi devre dışı bırakır.', ''],
  ]}
/>
