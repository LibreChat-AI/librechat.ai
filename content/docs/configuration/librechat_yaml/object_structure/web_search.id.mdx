...
Gunakan `webSearch.allowedAddresses` ketika endpoint penyedia SearXNG, Firecrawl, Jina, yang kompatibel dengan Tavily, yang kompatibel dengan Keenable, atau penyedia terkait yang dikonfigurasi bersifat privat secara sengaja:
...
<OptionTable
  options={[
    ['searchProvider', 'String', 'Menentukan penyedia pencarian mana yang akan digunakan.', 'Options: "serper", "searxng", "tavily", "keenable"'],
  ]}
/>
...
<OptionTable
  options={[
    ['keenableApiKey', 'String', 'Nama variabel lingkungan untuk kunci API Keenable opsional. Keenable dapat berfungsi tanpa kunci; mengonfigurasinya akan meningkatkan batas tarif publik.', '${KEENABLE_API_KEY}'],
  ]}
/>
...
<OptionTable
  options={[
    ['keenableApiUrl', 'String', 'Nama variabel lingkungan untuk URL API pencarian Keenable kustom. Ini tidak mengubah endpoint pengambilan halaman.', '${KEENABLE_API_URL}'],
  ]}
/>

Endpoint page-fetch dikonfigurasi secara terpisah dengan variabel khusus lingkungan `KEENABLE_FETCH_URL`.

### keenableSearchOptions

<OptionTable
  options={[
    ['keenableSearchOptions', 'Object', 'Opsi konfigurasi untuk pencarian Keenable.', ''],
  ]}
/>

<OptionTable
  options={[
    ['maxResults', 'Number', 'Jumlah maksimum hasil pencarian.', 'Range: 1-20. Default: 8'],
    ['site', 'String', 'Membatasi hasil ke satu domain.', ''],
    ['attributionTitle', 'String', 'Nilai yang dikirim dalam header atribusi X-Keenable-Title.', ''],
    ['timeout', 'Number', 'Batas waktu permintaan HTTP sisi klien dalam milidetik.', 'Range: 0-120000. Default: 15000'],
  ]}
/>
...
<OptionTable
  options={[
    ['scraperProvider', 'String', 'Menentukan layanan scraper mana yang akan digunakan.', 'Options: "firecrawl", "serper", "tavily", "keenable"'],
  ]}
/>
...
<OptionTable
  options={[
    ['keenableScraperOptions', 'Object', 'Opsi konfigurasi untuk pengambilan halaman Keenable.', ''],
  ]}
/>
...
Keenable dapat menyediakan pencarian, pengambilan halaman, atau keduanya. Endpoint publiknya berfungsi tanpa kunci; `keenableApiKey` opsional akan meningkatkan batas kecepatan (rate limits). Atur `rerankerType: "none"` untuk menghindari keharusan menggunakan kunci reranker:
...
- Keenable mendukung pencarian tanpa kunci (keyless search) dan pengambilan halaman (page fetch); kuncinya yang bersifat opsional dapat meningkatkan batas tarif publik, dan penggantian URL pengambilan (fetch URL override) hanya berlaku untuk lingkungan (environment-only).
