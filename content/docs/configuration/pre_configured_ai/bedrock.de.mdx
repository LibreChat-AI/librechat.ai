...
- Claude Fable/Mythos-Klasse-Modelle auf Bedrock sind nur über Inference-Profile verfügbar. Verwenden Sie eine Profil-ID wie `global.anthropic.claude-fable-5-1` und aktivieren Sie die Anthropic-Datenfreigabe in der Bedrock-Konsole oder über die Data Retention API, bevor Sie diese aufrufen. Fable 5.1 verfügt über ein Kontextfenster von 1 Mio. Token, eine maximale Ausgabe von 128.000 Token, adaptives Denken und Unterstützung für Prompt-Caching.
