...
## Erstellen von benutzerdefinierten Inferenzprofilen [#creating-custom-inference-profiles]
...
Fügen Sie die `bedrock` endpoint-Konfiguration zu Ihrer `librechat.yaml` hinzu. Für eine vollständige Referenz der Felder siehe [AWS Bedrock Object Structure](/docs/configuration/librechat_yaml/object_structure/aws_bedrock).
...
### Weitergabe der Modellzugriffsvereinbarung [#model-access-agreement-propagation]
...
### Konfigurationsladung überprüfen [#verify-config-loading]
...
### Schnelleinrichtungsskript [#quick-setup-script]
...
- [AWS Bedrock Objektstruktur](/docs/configuration/librechat_yaml/object_structure/aws_bedrock) - YAML-Konfigurationsfeldreferenz
