...
- Gemini 3.7 Flash, Gemini 3.6 Flash, Gemini 3.5 Flash en Gemini 3.5 Flash-Lite worden ondersteund via zowel Google AI Studio als Vertex AI. LibreChat wijst aan elk een contextvenster van 1.048.576 tokens toe.
- LibreChat stelt voor Gemini 3.7 Flash, Gemini 3.6 Flash en Gemini 3.5 Flash standaard `MEDIUM` thinking in, en voor Gemini 3.5 Flash-Lite `MINIMAL`. Gemini 3.7 Flash weigert `MINIMAL`, dus LibreChat vervangt dit door `LOW` wanneer dat niveau wordt aangevraagd; andere ondersteunde expliciete `thinkingLevel` waarden blijven behouden.
...
- Gemini 3.7 Flash ondersteunt geen assistant prefill. LibreChat voorkomt dat bewerkte assistant-antwoorden opnieuw worden ingediend als een niet-ondersteunde trailing model-role turn.
- Ingebouwde kostenramingen gebruiken de Gemini 3.6/3.7 Flash introductietarieven tot en met 31 december 2026: $0,75 input, $3,75 output en $0,075 gecachte input per miljoen tokens.
