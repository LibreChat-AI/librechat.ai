...
- Gemini 3.7 Flash, Gemini 3.6 Flash, Gemini 3.5 Flash et Gemini 3.5 Flash-Lite sont pris en charge via Google AI Studio et Vertex AI. LibreChat leur attribue à chacun une fenêtre de contexte de 1 048 576 jetons.
- LibreChat définit par défaut Gemini 3.7 Flash, Gemini 3.6 Flash et Gemini 3.5 Flash sur le niveau de réflexion `MEDIUM`, et Gemini 3.5 Flash-Lite sur `MINIMAL`. Gemini 3.7 Flash rejetant `MINIMAL`, LibreChat le remplace par `LOW` lorsque ce niveau est demandé ; les autres valeurs explicites de `thinkingLevel` prises en charge sont conservées.
...
- Gemini 3.7 Flash ne prend pas en charge le préremplissage de l'assistant (assistant prefill). LibreChat empêche les réponses de l'assistant modifiées d'être soumises à nouveau en tant que tour de rôle de modèle final non pris en charge.
- Les estimations de coûts intégrées utilisent les tarifs de lancement de Gemini 3.6/3.7 Flash jusqu'au 31 décembre 2026 : 0,75 $ en entrée, 3,75 $ en sortie et 0,075 $ par million de jetons pour les entrées en cache.
