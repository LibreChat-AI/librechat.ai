...
4. **LibreChat** con el endpoint Bedrock configurado (ver [AWS Bedrock Setup](/docs/configuration/pre_configured_ai/bedrock))
...
## Configuración de LibreChat [#configuring-librechat]
