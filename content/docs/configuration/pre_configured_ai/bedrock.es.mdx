...
- Los modelos Claude Fable/Mythos en Bedrock son solo para perfiles de inferencia. Utilice un ID de perfil como `global.anthropic.claude-fable-5-1` y habilite el intercambio de datos de Anthropic en la consola de Bedrock o en la API de retención de datos (Data Retention API) antes de invocarlos. Fable 5.1 cuenta con una ventana de contexto de 1M de tokens, una salida máxima de 128K tokens, razonamiento adaptativo y soporte para caché de prompts.
