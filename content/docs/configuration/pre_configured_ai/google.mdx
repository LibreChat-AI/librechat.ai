...
- Gemini 3.6 Flash, Gemini 3.5 Flash, and Gemini 3.5 Flash-Lite are supported through both Google AI Studio and Vertex AI. LibreChat assigns each a 1,048,576-token context window.
- LibreChat defaults Gemini 3.6 Flash and Gemini 3.5 Flash to `MEDIUM` thinking, and Gemini 3.5 Flash-Lite to `MINIMAL`. An explicit supported `thinkingLevel` is preserved.
