...
- Gemini 3.7 Flash, Gemini 3.6 Flash, Gemini 3.5 Flash và Gemini 3.5 Flash-Lite được hỗ trợ thông qua cả Google AI Studio và Vertex AI. LibreChat gán cho mỗi mô hình một cửa sổ ngữ cảnh 1.048.576 token.
- LibreChat mặc định Gemini 3.7 Flash, Gemini 3.6 Flash và Gemini 3.5 Flash ở mức tư duy `MEDIUM`, và Gemini 3.5 Flash-Lite ở mức `MINIMAL`. Gemini 3.7 Flash từ chối `MINIMAL`, vì vậy LibreChat sẽ thay thế bằng `LOW` khi mức đó được yêu cầu; các giá trị `thinkingLevel` rõ ràng khác được hỗ trợ sẽ được giữ nguyên.
...
- Gemini 3.7 Flash không hỗ trợ assistant prefill. LibreChat ngăn chặn việc các phản hồi của assistant đã chỉnh sửa bị gửi lại dưới dạng lượt hội thoại model-role không được hỗ trợ.
- Các ước tính chi phí tích hợp sử dụng mức giá giới thiệu của Gemini 3.6/3.7 Flash đến hết ngày 31 tháng 12 năm 2026: $0.75 cho đầu vào, $3.75 cho đầu ra và $0.075 cho đầu vào được lưu trong bộ nhớ đệm trên mỗi triệu token.
