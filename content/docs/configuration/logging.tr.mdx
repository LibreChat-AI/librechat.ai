...
<OptionTable
  options={[
    ...
    ['OTEL_LOG_LEVEL', 'string', 'OpenTelemetry SDK günlük seviyesi.', '# OTEL_LOG_LEVEL=INFO'],
    [
      'OTEL_SDK_DISABLED',
      'boolean',
    ...
    [
      ...
      'boolean',
      'Redis komut düzeyi aralıklarını etkinleştirin. Arka uç izlerini üst düzeyde tutmak için varsayılan olarak devre dışıdır.',
