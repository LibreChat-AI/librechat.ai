...
When you run LibreChat from source, run Meilisearch as a separate process and point LibreChat at it.

<Steps>
<Step>

**Run Meilisearch.** The simplest option is Docker, which avoids managing a binary. Generate a master key and start the container:
...
For other installation methods, see the [Meilisearch installation guide](https://www.meilisearch.com/docs/learn/getting_started/installation).
