...
<OptionTable
  options={[
    ['BAN_VIOLATIONS', 'boolean', 'Si se debe permitir o no el baneo de usuarios por infracciones (seguirán siendo registrados).','BAN_VIOLATIONS=true'],
...
<OptionTable
  options={[    
    ...
    ['CONCURRENT_VIOLATION_SCORE', 'integer', 'Puntuación por violaciones simultáneas.','CONCURRENT_VIOLATION_SCORE=1'],
