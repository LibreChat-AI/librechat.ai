...
<OptionTable
  options={[    
    ['LIMIT_IMPORT_USER', 'boolean', 'Si se debe limitar la cantidad de importaciones de conversaciones que un usuario puede realizar por `IMPORT_USER_WINDOW`.','LIMIT_IMPORT_USER=false'],
