...
En producción, deberías tener Cloudflare u otra protección DDoS implementada para proteger realmente el servidor contra solicitudes excesivas, pero estos cambios te protegerán en gran medida de uno o varios actores malintencionados que apunten a tu instancia desplegada para realizar proxying.
...
<OptionTable
  options={[
    ...
    ['BAN_DURATION', 'integer', 'Cuánto tiempo estarán bloqueados el usuario y la IP asociada (en milisegundos).','BAN_DURATION=1000 * 60 * 60 * 2'],
