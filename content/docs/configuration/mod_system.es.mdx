...
En producción, debería tener Cloudflare u otra protección DDoS implementada para proteger realmente el servidor contra solicitudes excesivas, pero estos cambios lo protegerán en gran medida de uno o varios actores malintencionados que tengan como objetivo su instancia desplegada para realizar proxy.
