...
En producción, debería contar con Cloudflare u otra protección DDoS para proteger realmente el servidor contra solicitudes excesivas, pero estos cambios le protegerán en gran medida de uno o varios actores malintencionados que intenten utilizar su instancia desplegada como proxy.
...
<OptionTable
  options={[    
    ...
    ['FORK_VIOLATION_SCORE', 'integer', 'Puntuación para infracciones de bifurcación de conversaciones.','FORK_VIOLATION_SCORE=1'],
    ...
    ['FILE_UPLOAD_VIOLATION_SCORE', 'integer', 'Puntuación para infracciones de carga de archivos.','FILE_UPLOAD_VIOLATION_SCORE=0'],
    ...
    ['VERIFY_EMAIL_VIOLATION_SCORE', 'integer', 'Puntuación para violaciones de verificación de correo electrónico.','VERIFY_EMAIL_VIOLATION_SCORE=0'],
...
<OptionTable
  options={[    
    ['LIMIT_IMPORT_USER', 'boolean', 'Define si se debe limitar la cantidad de importaciones de conversaciones que un usuario puede realizar por `IMPORT_USER_WINDOW`.','LIMIT_IMPORT_USER=false'],
...
<OptionTable
  options={[    
    ['LIMIT_FORK_IP', 'boolean', 'Determina si se debe limitar la cantidad de bifurcaciones de conversación que una IP puede crear por `FORK_IP_WINDOW`.','LIMIT_FORK_IP=true'],
