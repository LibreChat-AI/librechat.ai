...
<OptionTable
  options={[    
    ['LIMIT_IMPORT_IP', 'boolean', 'Si se debe limitar la cantidad de importaciones de conversación que una IP puede realizar por `IMPORT_IP_WINDOW`.','LIMIT_IMPORT_IP=true'],
