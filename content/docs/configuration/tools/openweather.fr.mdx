...
2. **Ville introuvable**
   ...
   - Essayez d'ajouter le code pays (par exemple, "London,UK")
   - Utilisez plutôt les coordonnées de latitude et de longitude
...
- Consultez les [LibreChat Issues](https://github.com/LibreChat-AI/LibreChat/issues)
- Consultez la [documentation de l'API](https://openweathermap.org/api/one-call-3) d'OpenWeather
- Contactez le [support](https://openweathermap.org/support-centre) d'OpenWeather pour les problèmes spécifiques à l'API
