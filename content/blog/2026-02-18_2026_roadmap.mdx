...
- Multi-agent support through our app-agnostic [Agents framework](https://github.com/LibreChat-AI/agents/)
...
The v1 Admin Panel ([#3137](https://github.com/LibreChat-AI/LibreChat/issues/3137)) will have four core capabilities:
...
- **Agent Skills** ([#11106](https://github.com/LibreChat-AI/LibreChat/issues/11106))
...
- [Event-driven lazy tool execution](https://github.com/LibreChat-AI/LibreChat/pull/11588) for MCP tools
...
- **Human-in-the-Loop** ([#5580](https://github.com/LibreChat-AI/LibreChat/issues/5580))
...
- **Background Agents and Subagents** ([#11687](https://github.com/LibreChat-AI/LibreChat/issues/11687) adjacent)
...
- File retention policies (automatic cleanup and expiry) ([#2365](https://github.com/LibreChat-AI/LibreChat/issues/2365))
- File storage limits per configuration profile ([#3057](https://github.com/LibreChat-AI/LibreChat/issues/3057))
...
- MCP Apps ([#10641](https://github.com/LibreChat-AI/LibreChat/issues/10641), [PR #11799](https://github.com/LibreChat-AI/LibreChat/pull/11799))
- Keyboard shortcuts ([#3664](https://github.com/LibreChat-AI/LibreChat/issues/3664))
- Chat folders and projects ([#4848](https://github.com/LibreChat-AI/LibreChat/issues/4848))
- A unified file upload experience ([#10941](https://github.com/LibreChat-AI/LibreChat/discussions/10941))
- Visible conversation cost and usage metrics ([#1215](https://github.com/LibreChat-AI/LibreChat/issues/1215))
...
<Cards>
  <Cards.Card
    ...
    href="https://github.com/LibreChat-AI/LibreChat/discussions/11860"
    target="_blank"
    icon={<Github />}
  />
  <Cards.Card
