...
- Add ability to send files to provider ([#4616](https://github.com/LibreChat-AI/LibreChat/issues/4616)):
...
- `librechat.yaml`: Specify vision models per provider or for all providers, as well as the default vision model ([#1634](https://github.com/LibreChat-AI/LibreChat/issues/1634))
- `librechat.yaml`: Custom token rates for Endpoints ([#1633](https://github.com/LibreChat-AI/LibreChat/issues/1633))
- `librechat.yaml`: Custom Welcome Message for Landing ([#2967](https://github.com/LibreChat-AI/LibreChat/issues/2967))
...
- Dynamic prompt variables for Agent instructions ([#5007](https://github.com/LibreChat-AI/LibreChat/issues/5007))
- User-specific memories ([#5494](https://github.com/LibreChat-AI/LibreChat/issues/5494))
- Extension of Prompt Library features to Agent/Assistant Conversation Starters ([#5053](https://github.com/LibreChat-AI/LibreChat/issues/5053))
- Favoriting and Custom Ordering of Prompt Library Entries ([#4875](https://github.com/LibreChat-AI/LibreChat/issues/4875))
- Keyboard shortcuts for Quick-access/navigation ([#3664](https://github.com/LibreChat-AI/LibreChat/issues/3664))
- Enhancing Artifacts to support markdown/notes, similar to ChatGPT's canvas ([#3995](https://github.com/LibreChat-AI/LibreChat/issues/3995))
...
- Human-in-the-loop for tool usage (allow user to approve a tool when used) ([#5580](https://github.com/LibreChat-AI/LibreChat/issues/5580))
- Creation of teams, groups, workspaces ([#4730](https://github.com/LibreChat-AI/LibreChat/issues/4730))
- Deep research tool
- Better search integration, including UI elements for sources/citations ([#4615](https://github.com/LibreChat-AI/LibreChat/issues/4615))
- Chat rating for feedback ([#901](https://github.com/LibreChat-AI/LibreChat/issues/901))
- Info/metadata for individual messages and conversations ([#1241](https://github.com/LibreChat-AI/LibreChat/issues/1241), [#1215](https://github.com/LibreChat-AI/LibreChat/issues/1215), [#5199](https://github.com/LibreChat-AI/LibreChat/issues/5199))
  - Includes projected cost, timestamp, etc.
- Scheduled Tasks (Agent workflows)
- OpenAI Realtime audio + Gemini Multimodal support ([#4382](https://github.com/LibreChat-AI/LibreChat/issues/4382))
- User-provided API Keys for Tools + RAG API ([#4758](https://github.com/LibreChat-AI/LibreChat/issues/4758))
- If `user_provided` API KEY value is used, fetch models for user ([#1028](https://github.com/LibreChat-AI/LibreChat/issues/1028))
- Conversation/file retention settings ([#2365](https://github.com/LibreChat-AI/LibreChat/issues/2365))
- Conversation/message limits per user ([#3058](https://github.com/LibreChat-AI/LibreChat/issues/3058))
- File storage limits per user ([#3057](https://github.com/LibreChat-AI/LibreChat/issues/3057))
- Organize chats into folders/projects ([#4848](https://github.com/LibreChat-AI/LibreChat/issues/4848))
- Allow Title Endpoint/Models to be used for different Endpoints ([#3321](https://github.com/LibreChat-AI/LibreChat/issues/3321))
- Setting to Display the model name in the conversation ([#3203](https://github.com/LibreChat-AI/LibreChat/issues/3203))
- Allow import/export function for all chats ([#3768](https://github.com/LibreChat-AI/LibreChat/issues/3768))
- S3 and S3-like File Storage support ([#2898](https://github.com/LibreChat-AI/LibreChat/issues/2898))
- Send messages that contain only images ([#3157](https://github.com/LibreChat-AI/LibreChat/issues/3157))
### Partnerships
...
Additional items that were not mentioned--whether already proposed or suggested in the future by the community, in both our [Discussions](https://github.com/LibreChat-AI/LibreChat/discussions/categories/feature-requests-suggestions) and [Issues](https://github.com/LibreChat-AI/LibreChat/issues?q=is%3Aissue%20state%3Aopen%20label%3A%22%E2%9C%A8%20enhancement%22) pages--will continue to be reviewed and may be implemented based on demand and contributions. The best way to support one of these items is to leave a reaction on their appropriate page (all of them will be programmatically tallied for a thorough analysis), as well as mention them in the dedicated Roadmap threads linked below.
...
<Cards>
  <Cards.Card
    ...
    href="https://github.com/LibreChat-AI/LibreChat/discussions/5960"
    target="_blank"
    icon={<Github />}
  />
  <Cards.Card
