...
I'm excited to announce that the **Assistants API** integration is now live on the main branch! Be sure to read [the updated setup guide](/docs/configuration/pre_configured_ai/assistants).
